							...
							<td width="341" valign="top" '.$rightborder.' id="'.(($ifee==1)?'hBank':(($ifee == 2)?'hAccounts':'hStudents')).'">
								<div class="row">
									<table style="border-collapse:collapse;" width="100%" border="0">
										<tr>
											<td>
												<img src="'.$_SESSION['userlogininfo']['LOGINCAMPUSLOGO'].'" class="img-fluid" style="width: 70px;">
											</td>
											<td>
												<h4>'.$value_campus['campus_name'].'</h4>
												<h4>'.$value_campus['primary_bank'].' Collection Account #'.$value_campus['primary_account'].'</h4>
											</td>
											<td>
								...
								<div style="font-size:13px; color:#000; margin-top:20px;">
									<table width="100%" border="0" style="border-collapse:collapse;" cellpadding="0" cellspacing="5">
										...
										<tr>
											<td style="font-weight:normal; font-style:italic; color: #777777; text-align:left; font-size:9px; width:80%;">';
												...
												<div style="position: relative;">
													<img src="https://chart.apis.google.com/chart?cht=qr&chs=70x70&chl='.$feercord['challan_no'].'" style="position: absolute; right: -75px; top: -80px;" width="70" height="70">
												</div>';
												echo'
											</td>
										</tr>
							...
							<table style="border-collapse:collapse;" width="100%" border="0">
								<tr>
									...
									<td>
										...
										<h4 style="font-size: 12px;">'.$value_campus['primary_bank'].' Collection Account #'.$value_campus['primary_account'].'</h4>
									</td>
									<td>
										<h6 style="margin-right: 0px;writing-mode: vertical-lr; text-orientation: mixed; border: 1px dashed black; border-radius: 12px; padding: 5px 3px;"> <span class="spanh1">'.$copyfor.'</span></h6>
									</td>
