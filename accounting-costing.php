...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Costing Sheet | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			<header class="panel-heading">
				<a href="#addcosting" class="modal-with-move-anim btn btn-primary btn-xs pull-right"><i class="fa fa-plus-square"></i> Make Voucher</a>
				<h2 class="panel-title"><i class="fa fa-list"></i> Costing List</h2>
			</header>
			<div class="panel-body">
				<table class="table table-bordered table-condensed table-striped mb-none" id = "table_export">
					<thead>
						<tr>
							<th>#</th>
							<th>Title</th>
					...
					<tbody>
							...
							<td>
								<!-- EDITING LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/accounting/modal_costing_update.php?id=13');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/costing/delete/13');">
							...
							<td>
								<!-- EDITING LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/accounting/modal_costing_update.php?id=11');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/costing/delete/11');">
								<i class="el el-trash"></i>
								</a>
							</td>
						</tr>
							...
							<td>
								<!-- EDITING LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/accounting/modal_costing_update.php?id=12');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/costing/delete/12');">
								<i class="el el-trash"></i>
								</a>
							</td>
						</tr>
							...
							<td>
								<!-- EDITING LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/accounting/modal_costing_update.php?id=9');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/costing/delete/9');">
								<i class="el el-trash"></i>
								</a>
							</td>
						</tr>
							...
							<td>
								<!-- EDITING LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/accounting/modal_costing_update.php?id=10');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/costing/delete/10');">
								<i class="el el-trash"></i>
								</a>
							</td>
						</tr>
							...
							<td>
								<!-- EDITING LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/accounting/modal_costing_update.php?id=8');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/costing/delete/8');">
								<i class="el el-trash"></i>
								</a>
							</td>
						</tr>
							...
							<td>
								<!-- EDITING LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/accounting/modal_costing_update.php?id=4');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/costing/delete/4');">
								<i class="el el-trash"></i>
								</a>
							</td>
						</tr>
							...
							<td>
								<!-- EDITING LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/accounting/modal_costing_update.php?id=3');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/costing/delete/3');">
								<i class="el el-trash"></i>
								</a>
							</td>
						</tr>
							...
							<td>
								<!-- EDITING LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/accounting/modal_costing_update.php?id=1');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/costing/delete/1');">
								<i class="el el-trash"></i>
								</a>
							</td>
						</tr>
		...
		<div id="addcosting" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
			<section class="panel panel-featured panel-featured-primary">
				<form action="accounting/costing/make/" class="form-horizontal validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				...
				<div class="panel-body">
					<div class="form-group mt-sm">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" name="name" value="" required title="Must Be Required" autofocus />
						</div>
					</div>
						...
						<div class="col-sm-9">
							...
							title="Must Be Required">
								<option value="">Select Costing Category</option>
																<option value="1"> Building development</option>
																<option value="3"> office expense</option>
																<option value="4"> Genarell fund</option>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="number" class="form-control" name="amount" value="" required title="Must Be Required">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" name="voucherID" value="" required title="Must Be Required">
						</div>
					</div>
					...
					<div class="form-group mb-md">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" data-plugin-datepicker data-plugin-options='{ "todayHighlight" : true }' name="timestamp" required
							title="Must Be Required"/>
						</div>
					</div>
				</div>
