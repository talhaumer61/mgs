...
<!-- end: sidebar -->
	...
	<form action="timetable/exam_update/edit/1" id="form" method="post" accept-charset="utf-8">
	<header class="panel-heading">
		<h2 class="panel-title"><i class="fa fa-clock-o"></i> Edit Exam Timetable</h2>
	</header>
				...
				<div class="row">
					...
					<div class="col-sm-4 mt-sm">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="exam_time" required title="Must Be Required" value="60" >
						</div>
					</div>
					...
					<div class="col-sm-4 mt-sm">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="pass_mark" required title="Must Be Required" value="33">
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-sm-6 mt-sm">
						<div class="form-group">
							...
							data-plugin-options='{ "todayHighlight" : true }' name="date" value="09/01/2017"/>
						</div>
					</div>
					<div class="col-sm-6 mt-sm">
						<div class="form-group">
							<label class="control-label">Class Room</label>
							<input type="text" class="form-control" name="class_room" value="#1" >
						</div>
					</div>
				</div>
				<div class="row mb-sm">
					<div class="col-sm-6 mt-sm">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" name="time_start" value = "10:00 AM" required title="Must Be Required" 
								data-plugin-timepicker class="form-control" data-plugin-options='{ "minuteStep": 5 }'>
							</div>
							</div>
					</div>
					<div class="col-sm-6 mt-sm">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" name="time_end" value = "1:00 PM" required title="Must Be Required"
								data-plugin-timepicker class="form-control" data-plugin-options='{ "minuteStep": 5 }'>
							</div>
						</div>
					</div>
