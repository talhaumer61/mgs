			...
			<div class="panel-body">
				<table class="table table-bordered table-condensed table-striped mb-none" id = "table_export">
					...
					<tbody>
												<tr>
							<td>1</td>
							<td class="center"><img src="uploads/teacher_image/1.jpg" width="35" height="35" /></td>
							<td>Anzo Perez</td>
							<td>Teacher</td>
							<td>Sample 1</td>
							<td>31-Aug-2017</td>
...
<div id="view52" class="zoom-anim-dialog modal-block modal-block-lg mfp-hide">
	<section class="panel panel-featured panel-featured-primary">
		<form action="leave/control/update/52" class="validate" method="post" accept-charset="utf-8">
		<header class="panel-heading">
			<h2 class="panel-title"><i class="fa fa-user-circle-o"></i> Leaving information of Anzo Perez</h2>
		</header>
		<div class="panel-body">
			<div class="row mt-md">
				<div class="col-md-6">
							...
							<div class="table-responsive mt-sm">
								<table class="table">
									<tbody>
										...
										<tr>
											<th> Reason : </th>
											<td> Enter Any Reason Here</td>
										</tr>
										<tr>
											<th colspan="2" class="center">
												<select name="status" class='form-control populate' required data-plugin-selectTwo data-width='100%'
...
<div id="view51" class="zoom-anim-dialog modal-block modal-block-lg mfp-hide">
	<section class="panel panel-featured panel-featured-primary">
		<form action="leave/control/update/51" class="validate" method="post" accept-charset="utf-8">
		<header class="panel-heading">
			<h2 class="panel-title"><i class="fa fa-user-circle-o"></i> Leaving information of Anzo Perez</h2>
		</header>
		<div class="panel-body">
