...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Online Admission Panel | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary appear-animation" data-appear-animation="fadeInRight" data-appear-animation-delay="100">
			<header class="panel-heading">
				<h2 class="panel-title"><i class="fa fa-id-card-o"></i> Application List</h2>
			</header>
			<div class="panel-body">
			<table class="table table-bordered table-striped table-condensed mb-none table_default" >
				...
				<tbody>
										<tr>
						<td>0 </td>
						<td class="center"> <img src="uploads/defualt.png" width="35"/> </td>
						<td>Joseph Chadwick</td>
						<td>One</td>
						<td>A</td>
						<td>31/Aug/2017</td>
						<td>JosephChadwick@gmail.com </td>
						<td>+44 079 6146 4905 </td>
						<td>General</td>
						<td width="160px">
							<!-- STUDENT ACCEPT LINK -->
							<a href="#" onclick="confirm_accept('admission/control/accept/1');" class="btn btn-primary btn-xs" style="width: 70px" >
							    <i class="el el-check"></i> Accept							</a>

							<!-- STUDENT DELETE LINK -->
							<a href="#" class="btn btn-danger btn-xs"  style="width: 70px" onclick="confirm_reject('admission/control/reject/1');">
								<i class="el el-remove-sign"></i> Reject							</a>
						</td>
					</tr>
										<tr>
						<td>0 </td>
						<td class="center"> <img src="uploads/defualt.png" width="35"/> </td>
						<td>Madhavi Chopra</td>
						<td>One</td>
						<td>A</td>
						<td>31/Aug/2017</td>
						<td>madhavichopra@ymail.com </td>
						<td>+91 708 4644801 </td>
						<td>General</td>
						<td width="160px">
							<!-- STUDENT ACCEPT LINK -->
							<a href="#" onclick="confirm_accept('admission/control/accept/2');" class="btn btn-primary btn-xs" style="width: 70px" >
							    <i class="el el-check"></i> Accept							</a>

							<!-- STUDENT DELETE LINK -->
							<a href="#" class="btn btn-danger btn-xs"  style="width: 70px" onclick="confirm_reject('admission/control/reject/2');">
								<i class="el el-remove-sign"></i> Reject							</a>
						</td>
					</tr>
									</tbody>
...
<script type="text/javascript">
	function confirm_accept( delete_url ) {
		swal( {
			title: "Are you sure?",
			text: "You are agree to approval, this cannot be changed.",
			type: "info",
			...
			setTimeout(function(){
				...
				.done( function ( data ) {
					swal( {
						title: "Approved",
						text: "User has been successfully approved",
						type: "success"
					}, function () {
						location.reload();
					} );
	...
	function confirm_reject( delete_url ) {
		swal( {
			title: "Are you sure?",
			text: "You are agree to rejected, this cannot be changed.",
			type: "warning",
			showCancelButton: true,
			showLoaderOnConfirm: true,
			closeOnConfirm: false,
			...
			setTimeout(function(){
				...
				.done( function ( data ) {
					swal( {
						title: " Rejected",
						text: "User has been successfully Rejected",
						type: "success"
					}, function () {
						location.reload();
					} );
