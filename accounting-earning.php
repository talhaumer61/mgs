...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Earning Sheet | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			<header class="panel-heading">
				<a href="#addearning" class="modal-with-move-anim btn btn-primary btn-xs pull-right"><i class="fa fa-plus-square"></i> Make Voucher</a>
				<h2 class="panel-title"><i class="fa fa-list"></i> Earning List</h2>
			</header>
			<div class="panel-body">
				<table class="table table-bordered table-condensed table-striped mb-none" id = "table_export">
					...
					<tbody>
							...
							<td>
								<!-- EDITING LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/accounting/modal_earning_update.php?id=14');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/earning/delete/14');">
							...
							<td>
								<!-- EDITING LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/accounting/modal_earning_update.php?id=7');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/earning/delete/7');">
								<i class="el el-trash"></i>
								</a>
							</td>
						</tr>
							...
							<td>
								<!-- EDITING LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/accounting/modal_earning_update.php?id=6');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/earning/delete/6');">
								<i class="el el-trash"></i>
								</a>
							</td>
						</tr>
		...
		<div id="addearning" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
			<section class="panel panel-featured panel-featured-primary">
				<form action="accounting/earning/make/" class="form-horizontal validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				...
				<div class="panel-body">
					<div class="form-group mt-sm">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" name="name" value="" autofocus required title="Must Be Required">
						</div>
					</div>
