<?php 
//-----------------------------------------------
if(($_SESSION['userlogininfo']['LOGINIDA'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE']  == 1) || ($_SESSION['userlogininfo']['LOGINTYPE']  == 2) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '22', 'updated' => '1'))){ 
echo '
<!-- INCLUDEING PAGE -->
<div class="row appear-animation" data-appear-animation="fadeInRight" data-appear-animation-delay="100">';
//-----------------------------------------------
	include_once("include/employee/profile/detail.php");
//-----------------------------------------------
echo '
<div class="col-md-8">
...
//-----------------------------------------------
	include_once("include/employee/profile/edit_profile.php");
	//include_once("include/employee/profile/attendance.php");
	//include_once("include/employee/profile/leave.php");
	include_once("include/employee/profile/bank_details.php");
	include_once("include/employee/profile/change_password.php");
//-----------------------------------------------
echo '
	</div>
</div>
