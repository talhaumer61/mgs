...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Make Payments Invoice | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			...
			<div class="panel-body">
				<form action="accounting/payment" id="form" method="post" accept-charset="utf-8">
				...
				<div class="row mb-lg">
					...
					<div class="col-sm-4">
						...
						<select class="form-control" required data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" name="section_id" id="section_holder">
					...
					<div class="col-sm-4">
						<div class="form-group">
							...
							<select class="form-control" required data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" name="payment_type">
								<option value="s" >Make Single Payment Invoice</option>
								<option value="m" selected>Make Multi Payment Invoice</option>
							</select>
						</div>
					</div>
				</div>
				<center>
					<button type="submit" class="btn btn-primary"><i class="fa fa-check-square-o"></i> Done</button>
				</center>
			...
			<form action="accounting/maintain/make" id="frm" method="post" accept-charset="utf-8">
			<header class="panel-heading">
				<h2 class="panel-title">
					<i class="fa fa-credit-card-alt"></i> Make Payment Invoice Of Class One ( Section A )				</h2>
			</header>
			<div class="panel-body">
				<div class="row mt-xs">
					<div class="col-sm-4">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="title" required title="Must Be Required" autofocus />
						</div>
					</div>
					...
					<div class="col-sm-4">
						<div class="form-group">
							<label class="control-label">
								Fee Category <span class="required">*</span>
							</label>
							<select class="form-control" required data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" title="Must Be Required"
							name="fees_id" onchange="fee_category(this.value)">
								<option value="">Select Fee Category</option>
																<option value="1"> Academic Fees </option>
																<option value="2"> Sports Fee </option>
																<option value="3"> Monthly Fees </option>
																<option value="4"> books1 </option>
																<option value="5"> transapr </option>
																<option value="10"> Admission </option>
																<option value="11"> sample route, bus001 </option>
																<option value="12"> First Term Fees </option>
				...
				<div class="row mt-sm">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="amount" id="amount" placeholder="Enter Total Amount" required
					...
					<div class="col-sm-6">
						<div class="form-group">
							<label class="control-label">
								Discount							</label>
							<input type="text" class="form-control" name="discount" id="discount" placeholder="Enter Discount Amount"/>
						</div>
					</div>
				</div>
				...
				<div class="row mt-sm">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="amount_paid" id="amount_paid" placeholder="Enter Payment Amount" required
							title="Must Be Required"/>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" data-plugin-datepicker data-plugin-options='{ "todayHighlight" : true, "format": "dd-mm-yyyy" }' 
							name="date" required value="19-01-2019" title="Must Be Required"/>
						</div>
					</div>
				</div>
				...
				<div class="row mt-sm">
					<div class="col-sm-6">
						<div class="form-group">
							<label class="control-label">
								Remote Payment <span class="required">*</span>
							</label>
							<select name="remote_payment" class="form-control" data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity">
						...
						<div class="table-responsive">
							<table class="table table-bordered table-striped table-condensed mb-none" id="multi-form">
								...
								<tbody>
										...
										<td>
											<div class="checkbox-custom checkbox-default">
												<input type="checkbox" name="student_id[]" value="1">
												<label for="checkboxExample1"></label>
											</div>
										</td>
										<td class="center"><img src="uploads/student_image/1.jpg" width="30"/></td>
										<td>Cherri Portnoy</td>
										<td>101</td>
										<td>student@rudras.com</td>
									</tr>
																		<tr>
										<td>
											<div class="checkbox-custom checkbox-default">
												<input type="checkbox" name="student_id[]" value="2">
												<label for="checkboxExample1"></label>
											</div>
										</td>
										<td class="center"><img src="uploads/student_image/2.jpg" width="30"/></td>
										<td>Rudyard Maddox</td>
										<td>102</td>
										<td>rudyard@gmail.com</td>
									</tr>
																		<tr>
										<td>
											<div class="checkbox-custom checkbox-default">
												<input type="checkbox" name="student_id[]" value="3">
												<label for="checkboxExample1"></label>
											</div>
										</td>
										<td class="center"><img src="uploads/student_image/3.jpg" width="30"/></td>
										<td>Sweet Mondal</td>
										<td>103</td>
										<td>sweet_mondal@yahoo.com</td>
									</tr>
																		<tr>
										<td>
											<div class="checkbox-custom checkbox-default">
												<input type="checkbox" name="student_id[]" value="4">
												<label for="checkboxExample1"></label>
											</div>
										</td>
										<td class="center"><img src="uploads/student_image/4.jpg" width="30"/></td>
										<td>Blake Estes</td>
										<td>104</td>
										<td>blakestes@gmail.com</td>
									</tr>
																		<tr>
										<td>
											<div class="checkbox-custom checkbox-default">
												<input type="checkbox" name="student_id[]" value="5">
												<label for="checkboxExample1"></label>
											</div>
										</td>
										<td class="center"><img src="uploads/student_image/5.jpg" width="30"/></td>
										<td>Carter Bradford</td>
										<td>105</td>
										<td>cbradford@hotmail.com</td>
									</tr>
																		<tr>
										<td>
											<div class="checkbox-custom checkbox-default">
												<input type="checkbox" name="student_id[]" value="7">
												<label for="checkboxExample1"></label>
											</div>
										</td>
										<td class="center"><img src="uploads/defualt.png" width="30"/></td>
										<td>Shimul Roy</td>
										<td>2017</td>
										<td>shimul@example.com</td>
									</tr>
																	</tbody>
							</table>
						</div>
				...
				<input type="hidden" value="m" name="payment_type"/>
			</div>
...
<script type="text/javascript">
    ...
    function fee_category(fee_id) {
		if (fee_id == ''){
			document.getElementById("amount").value  = '';
			document.getElementById("description").value  = '';
		} else {
			$.ajax( {
				url: 'accounting/get_fee_amount/' + fee_id,
				success: function ( response ) {
			...
			$.ajax( {
				url: 'accounting/get_fee_description/' + fee_id,
				success: function ( response ) {
	...
	jQuery(document).ready(function ($) {
		$("form#frm").validate({
			...
			messages: {
				amount: {
					number: 'Please enter only numbers contain.'
				},
...
<script type="text/javascript">
	jQuery( document ).ready( function ( $ ) {
		...
		var $state = $( "#multi-form thead input[type='checkbox']" );

		// Script to select all checkboxes
		$state.on( 'change', function ( ev ) {
			var $chcks = $( "#multi-form tbody input[type='checkbox']" );
