...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Exam Timetable | Rudras School</title>
...
<!-- end: sidebar -->
			...
			<div class="row mb-lg">
				<div class="col-md-6">
					<div class="form-group">
						...
						<select class="form-control" required data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" required title="Must Be Required"
						id="class_id" onchange="select_section(this.value)">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						required title="Must Be Required" id="section_holder">
	...
	<section class="panel panel-featured panel-featured-primary appear-animation mt-sm" data-appear-animation="fadeInRight" data-appear-animation-delay="100">
		<header class="panel-heading">
			<h2 class="panel-title"><i class="fa fa-clock-o"></i> Class One ( Section A ) Exam Timetable</h2>
		</header>
		<div class="panel-body">
			<table class="table table-bordered table-striped table-condensed mb-none" id = "table_export">
				...
				<tbody>
						...
						<td>
							...
							<!-- EXAM TIMETABLE UPDATE LINK -->
							<a href="timetable/exam_update/1" class="btn btn-primary btn-xs">
								<i class="glyphicon glyphicon-edit"></i> Edit							</a>
						
							<!-- DELETION LINK -->
							<a href="#" class="btn btn-xs btn-danger" onclick="confirm_modal('timetable/make_exam/delete/1');">
						...
						<td>
							...
							<!-- EXAM TIMETABLE UPDATE LINK -->
							<a href="timetable/exam_update/2" class="btn btn-primary btn-xs">
								<i class="glyphicon glyphicon-edit"></i> Edit							</a>
						
							<!-- DELETION LINK -->
							<a href="#" class="btn btn-xs btn-danger" onclick="confirm_modal('timetable/make_exam/delete/2');">
								<i class="el el-trash"></i>
							</a>
						</td>
					</tr>
						...
						<td>
							...
							<!-- EXAM TIMETABLE UPDATE LINK -->
							<a href="timetable/exam_update/3" class="btn btn-primary btn-xs">
								<i class="glyphicon glyphicon-edit"></i> Edit							</a>
						
							<!-- DELETION LINK -->
							<a href="#" class="btn btn-xs btn-danger" onclick="confirm_modal('timetable/make_exam/delete/3');">
								<i class="el el-trash"></i>
							</a>
						</td>
					</tr>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function($)
	{
		var datatable = $('#table_export').dataTable({
			...
			bAutoWidth : false,
			ordering: false,
			sDom: "<'text-right'T>" + $.fn.dataTable.defaults.sDom,
			oTableTools: {
	...
	$( "#form" ).submit( function ( event ) {
		...
		if ( class_id != 0 && section_id != 0 ) {
			window.location.href = 'timetable/exam_view/' + class_id + '/' + section_id;
		}
