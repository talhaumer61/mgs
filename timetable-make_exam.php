...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Timetable Panel | Rudras School</title>
...
<!-- end: sidebar -->
				<section role="main" class="content-body">
					...
					<!-- INCLUDEING PAGE -->
					<section class="panel panel-featured panel-featured-primary">
	<form action="timetable/make_exam/new" id="form" method="post" accept-charset="utf-8">
	<header class="panel-heading">
		<h2 class="panel-title"><i class="fa fa-clock-o"></i> Make Exam Timetable</h2>
	</header>
	...
	<div class="panel-body">
		<div class="row">
			<div class="col-md-12">
				<div class="row">
					<div class="col-sm-4 mt-sm">
						<div class="form-group">
							...
							<select name="exam_id" data-plugin-selectTwo data-minimum-results-for-search="Infinity" data-width="100%" required title="Must Be Required"
					...
					<div class="col-sm-4 mt-sm">
						<div class="form-group">
							<label class="control-label">Exam Time (Min) <span class="required">*</span></label>
							<input type="text" class="form-control" name="exam_time" required title="Must Be Required" value="" >
						</div>
					</div>
					...
					<div class="col-sm-4 mt-sm">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="pass_mark" required title="Must Be Required" value="">
						</div>
					</div>
				</div>
				...
				<div class="row" id="section_subject" style="display: none;">
					<div class="col-sm-6 mt-sm" >
						<div class="form-group">
							<label class="control-label">Section <span class="required">*</span></label>
							<select name="section_id" data-plugin-selectTwo data-width="100%" required id="section_holder" class="form-control populate">
					...
					<div class="col-sm-6 mt-sm">
						<div class="form-group">
							...
							<select name="subject_id" data-plugin-selectTwo data-width="100%" id="subject_holder" required class="form-control populate">
								<option value = "">Select Class First</option>
							</select>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-sm-6 mt-sm">
						<div class="form-group">
							...
							<input type="text" class="form-control" required title="Must Be Required" data-plugin-datepicker
							data-plugin-options='{ "todayHighlight" : true }' name="date" value=""/>
						</div>
					</div>
					<div class="col-sm-6 mt-sm">
						<div class="form-group">
							<label class="control-label">Class Room</label>
							<input type="text" class="form-control" name="class_room" value="" >
						</div>
					</div>
				</div>
				...
				<div class="row mb-sm">
					<div class="col-sm-6 mt-sm">
						<div class="form-group">
							<label class="control-label">Starting Time <span class="required">*</span></label>
							<div class="input-group">
								<span class="input-group-addon">
								 <i class="fa fa-clock-o"></i>
								</span>
								<input type="text" name="time_start" required title="Must Be Required" data-plugin-timepicker
								class="form-control" data-plugin-options='{ "minuteStep": 5 }'>
							</div>
						</div>
					</div>
					<div class="col-sm-6 mt-sm">
						<div class="form-group">
							<label class="control-label">Ending Time <span class="required">*</span></label>
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
								<input type="text" name="time_end" required title="Must Be Required" data-plugin-timepicker
								class="form-control" data-plugin-options='{ "minuteStep": 5 }'>
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	function get_class_section_subject( class_id ) {
		$.ajax( {
			url: 'timetable/get_class_section/' + class_id,
		...
		$.ajax( {
			url: 'timetable/get_class_subject/' + class_id,
			success: function ( response ) {
		...
		if(class_id == '') {
            $("#section_subject").hide("slow");
        } else {
            $("#section_subject").show("slow");
        }
	}
</script>				</section>
			</div>
