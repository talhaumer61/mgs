					...
					<div class="col-sm-4">
						<div class="form-group">
							...
							<select class="form-control" required data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" name="payment_type">
								<option value="s" selected>Make Single Payment Invoice</option>
								<option value="m" >Make Multi Payment Invoice</option>
							</select>
						</div>
					</div>
				</div>
			...
			<div class="panel-body">
				...
				<div class="row mt-lg mb-lg">
					<div class="col-sm-12">
							...
							<select class="form-control" required title="Must Be Required" data-plugin-selectTwo data-width="100%" name="student_id">
								<option value="">Select Student</option>
																<option value="1">Cherri Portnoy / Roll - 101</option>
																<option value="2">Rudyard Maddox / Roll - 102</option>
																<option value="3">Sweet Mondal / Roll - 103</option>
																<option value="4">Blake Estes / Roll - 104</option>
																<option value="5">Carter Bradford / Roll - 105</option>
																<option value="7">Shimul Roy / Roll - 2017</option>
															</select>
						</div>
											</div>
				</div>
				<input type="hidden" value="s" name="payment_type"/>
			</div>
