...
<html class=" sidebar-light sidebar-left-big-icons sidebar-left-collapsed">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Profile Panel | Rudras School</title>
		...
		<section class="panel">
			<div class="panel-body">
				<div class="thumb-info mb-md">
					<img src="uploads/librarian_image/1.jpg" class="rounded img-responsive">
						...
						<div class="table-responsive">
							<table class="table table-striped table-condensed mb-none">
								...
								<tr>
									...
									<td align="right">librarian@rudras.com</td>
								</tr>
								<tr>
									<td><i class="fa fa-dot-circle-o"></i> Phone</td>
									<td align="right">+1-99-2431654</td>
								</tr>
							</table>
						</div>
					</div>
	...
	<div class="col-md-8">
		<div class="tabs tabs-primary">
			<ul class="nav nav-tabs">
				<li class="active">
					<a href="#edit" data-toggle="tab"><i class="fa fa-user"></i> <span class="hidden-xs">Librarian Profile</span></a>
				</li>
				<li class="">
			...
			<div class="tab-content">
				<div id="edit" class="tab-pane active">
				   <form action="librarian/maintain/update/1" class="validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
							...
							<div class="col-md-6">
								<div class="fileinput fileinput-new" data-provides="fileinput">
									<div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
										<img src="uploads/librarian_image/1.jpg" alt="...">
									</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="name" required title="Must Be Required" value="Xander Rowe" autofocus>
								</div>
							</div>
						...
						<div class="row mt-xs">
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea class="form-control" rows="3" name = "address">Raleigh, NC 27601, USA</textarea>
								</div>
							</div>
						</div>
						...
						<div class="row mt-xs">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="birthday" value="07/14/1988" required
									title="Must Be Required" data-plugin-datepicker >
								</div>
							</div>
							...
							<div class="col-md-6">
								...
								<label class="control-label"> Phone</label>
									<input type="text" class="form-control" name="phone" value="+1-99-2431654">
								</div>
							</div>
						</div>
							...
							<div class="col-md-6">
								...
								<label class="control-label">Blood group <span class="required">*</span></label>
								 <select name="blood_group" class='form-control populate' data-plugin-selectTwo data-width='100%'
									required title = "Value Required"data-minimum-results-for-search='Infinity' >
<option value="">Select</option>
...
<option value="AB-">AB-</option>
						...
						<div class="row mt-xs">
							<div class="col-md-12">
								<div class="form-group">
									...
									title="Must Be Required" value="02/02/2016">
								</div>
							</div>
						</div>
						...
						<div class="row mt-xs mb-md">
							<div class="col-md-12">
								<div class="form-group ">
									...
									<input type="email" class="form-control" name="email" required value="librarian@rudras.com">
																	</div>
							</div>
						</div>
					</fieldset>
					...
					<section class="panel panel-pvs-shadow mt-lg">
						<header class="panel-heading panel-featured-primary pvs-heading-tran">
							<div class="pull-right">
								<a href="#add_bank" class="modal-with-move-anim btn btn-xs btn-primary">
						...
						<div class="panel-body">
							<div class="table-responsive">
								...
								<tbody>
										...
										<td>
											<!-- UPDATE LINK -->
											<a href="#bank_edit0" class="modal-with-move-anim-pvs btn btn-xs btn-primary">
											<i class="glyphicon glyphicon-edit"></i>
											</a>

											<!-- DELETION LINK -->
											<a href="#" class="btn btn-xs btn-danger" onclick="confirm_modal('librarian/bank_info/delete/0');">
				...
				<div id="activity" class="tab-pane">
					<section class="panel panel-pvs-shadow mt-lg">
						...
						<div class="panel-body">
														<label class="control-label">Sample 1 (0/10)</label>    
							<div class="progress progress-lg progress-squared light prog-pvs" style="margin-top: 2px; margin-bottom: 8px;">
								...
								style="width: 0.0%;">
									0.0 %
														...
														<label class="control-label">Sample 2 (0/15)</label>    
							<div class="progress progress-lg progress-squared light prog-pvs" style="margin-top: 2px; margin-bottom: 8px;">
								<div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="15" 
								style="width: 0.0%;">
									0.0 %
								</div>
							</div>
							...
							<div class="progress progress-lg progress-squared light prog-pvs" style="margin-top: 2px; margin-bottom: 8px;">
								<div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="20" 
								style="width: 0.0%;">
									0.0 %
								</div>
							</div>
					...
					<section class="panel panel-pvs-shadow mt-lg">
						<header class="panel-heading panel-featured-primary pvs-heading-tran">
							<h2 class="panel-title">Attendance Report Of January Month</h2>
						</header>
						<div class="panel-body">
	            ...
	            <div id="resetpass" class="tab-pane">
					<form action="librarian/maintain/change_password/1" class="form-horizontal validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
						<fieldset class="mt-lg">
							<div class="form-group">
...
<div id="add_bank" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
	<section class="panel panel-featured panel-featured-primary">
		<form action="librarian/bank_info/make/1" class="form-horizontal validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
		<div class="panel-heading">
			<h2 class="panel-title">
				<i class="fa fa-plus-square"></i> Add Bank			</h2>
		</div>
		<div class="panel-body">
	...
	<div id="bank_edit0" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
		<section class="panel panel-featured panel-featured-primary">
			<form role="form" action="librarian/bank_info/update/0/1" method="post" class="validate">
				<header class="panel-heading">
					<h2 class="panel-title">
				...
				<div class="panel-body">
					<div class="form-group mt-sm">
						<label class="col-md-3 control-label">Bank Name <span class="required">*</span></label>
						<div class="col-md-9">
							<input type="text" class="form-control" name="bank_name" value="DBBL" required title="Must Be Required"/>
						</div>
					</div>
					...
					<div class="form-group mt-sm">
						<label class="col-md-3 control-label">Account Name <span class="required">*</span></label>
						<div class="col-md-9">
							<input type="text" class="form-control" name="account_name" value="Shimul Roy" required title="Must Be Required"/>
						</div>
					</div>
					...
					<div class="form-group mt-sm">
						<label class="col-md-3 control-label">Branch <span class="required">*</span></label>
						<div class="col-md-9">
							<input type="text" class="form-control" name="branch" value="Phultla" required title="Must Be Required"/>
						</div>
					</div>
					...
					<div class="form-group mt-sm">
						<label class="col-md-3 control-label">Bank Address</label>
						<div class="col-md-9">
							<input type="text" class="form-control" name="bank_address" value="Khulna-9210" />
						</div>
					</div>
					...
					<div class="form-group mt-sm">
						<label class="col-md-3 control-label">IFSC Code <span class="required">*</span></label>
						<div class="col-md-9">
							<input type="text" class="form-control" name="ifsc_code" value="10010D" required title="Must Be Required"/>
						</div>
					</div>
