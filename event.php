...
require_once("include/event/query_events.php");
...
if(($_SESSION['userlogininfo']['LOGINAFOR'] == 1 && $_SESSION['userlogininfo']['LOGINTYPE'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE'] == '1' && in_array('42', $_SESSION['userlogininfo']['PERMISSIONS'])) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '42', 'view' => '1'))) {
	echo '
	<title> Event Panel | '.TITLE_HEADER.'</title>
	<section role="main" class="content-body">
		...
		<div class="row">
			<div class="col-md-12">';
				include_once("include/event/list_events.php");
				include_once("include/modals/event/modal_event_add.php");
				echo '
			</div>
		</div>
	</section>';
