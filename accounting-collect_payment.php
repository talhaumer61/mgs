...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Invoice History | Rudras School</title>
				...
				<ol class="tm-items">
					<li>
						<div class="tm-box appear-animation" data-appear-animation="fadeInRight" data-appear-animation-delay="100">
							<div class="row">
								<div class="col-md-2 mt-xs mb-xs">
									<img class="img-thumbnail" width="110px"  height="110px" src="uploads/student_image/1.jpg">
								</div>
								<div class="col-md-10 mt-md mb-xs">
					...
					<li>
						<div class="tm-box appear-animation" data-appear-animation="fadeInRight" data-appear-animation-delay="250">
							<div class="text-right mb-lg">
								<a href="accounting/invoice_history" class="btn btn-xs btn-primary" >
									...
									<table class="table invoice-items">
										<thead>
											<tr class="h5 text-dark">
												...
												<th class="text-weight-semibold">Date</th>
												<th width="40%" class="text-weight-semibold">Description</th>
												<th id="cell-qty" class="text-center text-weight-semibold">Method</th>
							...
							<div class="text-right">
								<a class="mb-xs mt-xs mr-xs modal-with-move-anim btn btn-sm btn-primary" href="#take_payment"><i class="fa fa-plus-circle"></i> Collect Payment</a>
								<a class="mb-xs mt-xs mr-xs btn btn-sm btn-primary" href="accounting/invoice_view/317" ><i class="fa fa-newspaper-o"></i>
								View Invoice</a>
							</div>
...
<!-- MODAL FORM -->
<div id="take_payment" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
	<section class="panel panel-featured panel-featured-primary">
		<form action="accounting/maintain/take_payment/317" class="form-horizontal validate" method="post" accept-charset="utf-8">
		<div class="panel-heading">
			<h2 class="panel-title">Take Payment</h2>
		</div>
		<div class="panel-body">
			<div class="table-responsive mb-lg mt-md">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">Payment <span class="required">*</span></label>
				<div class="col-sm-10">
					<input type="number" class="form-control" name="amount" min = "1" max = "4790" required
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" name="paymentinfo" value="" placeholder="Enter Description"/>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group mb-lg">
				...
				<div class="col-sm-10">
					...
					data-plugin-options='{ "todayHighlight" : true, "format": "dd-mm-yyyy" }' name="timestamp" value="19-01-2019"/>
				</div>
			</div>
		...
		<footer class="panel-footer">
			<div class="row">
				<div class="col-md-12 text-right">
					<button class="btn btn-primary modal-confirm">Take Payment</button>
					<button class="btn btn-default modal-dismiss">Cancel</button>
				</div>
			</div>
		</footer>
