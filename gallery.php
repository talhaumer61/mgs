...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Media Gallery | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<header class="panel-heading">
		<a href="#make_video" class="modal-with-move-anim btn btn-primary btn-xs pull-right">
			<i class="fa fa-upload"></i> Upload Video		</a>
		<h2 class="panel-title"><i class="el el-video"></i> Video List</h2>
	</header>
	<div class="panel-body">
		<section class="media-gallery mt-md">
			<div class="row mg-files">
									<div class="isotope-item document col-md-4 col-lg-4 col-xl-3">
						<div class="thumbnail" style="margin-bottom: 10px; margin-top: 10px;">
							<div class="thumb-preview">
								<a class="thumb-image" href="#"> <img src="uploads/gallery_thumbnail/1.jpg" class="img-responsive"></a>
								<div class="mg-thumb-options">
									<a class="mg-zoom popup-youtube" href="https://www.youtube.com/watch?v=kJgAntw-BfM"><i class="fa fa-youtube-play"></i></a>
									<div class="mg-toolbar">
										<div style="display: inline-block; vertical-align: middle;">
											Everyone										</div>			
										<div class="mg-group pull-right">
											<span>Option</span>
											<button class="dropdown-toggle mg-toggle" type="button" data-toggle="dropdown"><i class="fa fa-caret-up"></i></button>
											<ul class="dropdown-menu mg-menu">
												<li>
													<a href="#show_modal" class="modal-with-move-anim-pvs" onclick="showAjaxModalZoom('ajax/modal/gallery/modal_media_gallery_update.php?id=1');">
													<i class="glyphicon glyphicon-edit"></i> Edit</a>
												</li>
												<li>
													<a href="#" onclick="confirm_modal('gallery/maintain/delete/1');"><i class="el el-trash"></i> Delete</a>
												</li>
												</ul>
										</div>
									</div>
							...
							<h5 class="mg-title text-weight-semibold"> FX 4K - Cinema Hero Title </h5>
							<div class="mg-description">
								<small class="pull-left text-muted"> PVS Fire FX 4K is Released with Realtime Projects </small> <br>
								<small class="pull-left text-muted"> 01 Aug, 2017 </small>
							</div>
						</div>
					</div>
									<div class="isotope-item document col-md-4 col-lg-4 col-xl-3">
						<div class="thumbnail" style="margin-bottom: 10px; margin-top: 10px;">
							<div class="thumb-preview">
								<a class="thumb-image" href="#"> <img src="uploads/gallery_thumbnail/2.jpg" class="img-responsive"></a>
								<div class="mg-thumb-options">
									<a class="mg-zoom popup-youtube" href="https://www.youtube.com/watch?v=8yN1Q6vV0gk&t=9s"><i class="fa fa-youtube-play"></i></a>
									<div class="mg-toolbar">
										<div style="display: inline-block; vertical-align: middle;">
											Student										</div>			
										<div class="mg-group pull-right">
											...
											<ul class="dropdown-menu mg-menu">
												<li>
													<a href="#show_modal" class="modal-with-move-anim-pvs" onclick="showAjaxModalZoom('ajax/modal/gallery/modal_media_gallery_update.php?id=2');">
													<i class="glyphicon glyphicon-edit"></i> Edit</a>
												</li>
												<li>
													<a href="#" onclick="confirm_modal('gallery/maintain/delete/2');"><i class="el el-trash"></i> Delete</a>
												</li>
												</ul>
										</div>
									</div>
							...
							<h5 class="mg-title text-weight-semibold"> FX 4K - Loket Hart </h5>
							<div class="mg-description">
								<small class="pull-left text-muted"> PVS Fire FX 4K is Released with Realtime Projects </small> <br>
								<small class="pull-left text-muted"> 01 Aug, 2017 </small>
							</div>
...
<div id="make_video" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
	<div class="row">
		<div class="col-md-12">
			<section class="panel panel-featured panel-featured-primary">
				<form action="gallery/maintain/make" class="form-horizontal mb-lg" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				...
				<div class="panel-body">
					<div class="form-group mt-sm">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" name="title" required title="Must Be Required" autofocus value="">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="url" class="form-control" name="youtube_link" required placeholder="e.g: https://www.youtube.com/watch?v=yourvideo" value="">
						</div>
					</div>
					
					<div class="form-group">
						<label class="col-md-3 control-label">Subtitle <span class="required">*</span></label>
						<div class="col-md-9">
							<input type="text" data-plugin-maxlength maxlength="50" class="form-control" name="description" required title="Must Be Required" value="">
						</div>
					</div>
					<div class="form-group">
...
<option value="2">Student</option>
					...
					<div id = "student_hidden" style="display: none;">
						<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="fileinput fileinput-new" data-provides="fileinput">
								<div class="fileinput-new thumbnail" style="width: 260px; height: 130px;" data-trigger="fileinput">
									<img src="uploads/gallery_thumbnail/Sample.png" alt="...">
								</div>
								<div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 260px; max-height: 130px"></div>
								<div>
									<span class="mr-xs btn btn-sm btn-default btn-file">
										<span class="fileinput-new">Select image</span>
										<span class="fileinput-exists">Change</span>
										<input type="file" required title=" " name="galleryfile" accept="image/*">
									</span>
...
<script type="text/javascript">
	function get_class_sections( class_id ) {
		...
		$.ajax( {
			url: 'gallery/get_class_admission_section/' + class_id,
	...
	function get_student_hidden( mode_id ) {
		if( mode_id == 1){
			$("#student_hidden").hide("slow");
		} else {
			$("#student_hidden").show("slow");
		}
	}
</script>				</section>
			</div>
