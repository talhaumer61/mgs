...
<div class="tabs tabs-primary">
	<ul class="nav nav-tabs">
		<li class="active">
			<a href="#template" data-toggle="tab"><i class="fa fa-tasks"></i> Template List</a>
		</li>
		<li>
			<a href="#create" data-toggle="tab"><i class="fa fa-code"></i> Make</a>
		</li>
	</ul>
	<div class="tab-content">
		<div id="template" class="tab-pane active">
			<div  class="mt-md mb-xs">
			<table class="table table-bordered table-striped table_default">
				<thead>
					<tr>
						<th>#</th>
						<th>Name</th>
				...
				<tbody>
					...
					<td>
						...
						<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#edit_11"><i class="glyphicon glyphicon-edit"></i>
							Edit						</a>
						<div id="edit_11" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
							<section class="panel panel-featured panel-featured-primary">
								<form role="form" action="bulksms/templates/update/11" method="post" class="validate">
									<header class="panel-heading">
										<h2 class="panel-title">
											<i class="glyphicon glyphicon-edit"></i> Edit										</h2>
									</header>
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<input type="text" class="form-control" required title="Must Be Required" value="School Open" name="template_name"/>
										</div>
										<div class="form-group mb-lg">
											<label class="control-label">
												Details											</label>
											<textarea name="template_description" data-plugin-summernote class="summernote"><p>{name}{phone}{designation}<br></p></textarea>
										</div>
									</div>
						...
						<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('bulksms/templates/delete/11');">
					...
					<td>123</td>
					<td>
						{name}{phone}{gender}{address}{blood_group}					</td>
					<td>
						<!-- TEMPLATE UPDATE LINK -->
						<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#edit_12"><i class="glyphicon glyphicon-edit"></i>
							Edit						</a>
						<div id="edit_12" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
							<section class="panel panel-featured panel-featured-primary">
								<form role="form" action="bulksms/templates/update/12" method="post" class="validate">
									<header class="panel-heading">
										<h2 class="panel-title">
											<i class="glyphicon glyphicon-edit"></i> Edit										</h2>
									</header>
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<input type="text" class="form-control" required title="Must Be Required" value="123" name="template_name"/>
										</div>
										<div class="form-group mb-lg">
											<label class="control-label">
												Details											</label>
											<textarea name="template_description" data-plugin-summernote class="summernote"><p>{name}{phone}{gender}{address}{blood_group}<br></p></textarea>
										</div>
									</div>
						...
						<!-- TEMPLATE DELETE LINK -->
						<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('bulksms/templates/delete/12');">
							<i class="el el-trash"></i>
						</a>
					</td>
					</tr>
					...
					<td>
						<!-- TEMPLATE UPDATE LINK -->
						<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#edit_13"><i class="glyphicon glyphicon-edit"></i>
							Edit						</a>
						<div id="edit_13" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
							<section class="panel panel-featured panel-featured-primary">
								<form role="form" action="bulksms/templates/update/13" method="post" class="validate">
									<header class="panel-heading">
										<h2 class="panel-title">
											<i class="glyphicon glyphicon-edit"></i> Edit										</h2>
									</header>
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<input type="text" class="form-control" required title="Must Be Required" value="teser" name="template_name"/>
										</div>
										<div class="form-group mb-lg">
											<label class="control-label">
												Details											</label>
											<textarea name="template_description" data-plugin-summernote class="summernote"><p>{name} your fee due last date 3-10-17<br></p></textarea>
										</div>
									</div>
						...
						<!-- TEMPLATE DELETE LINK -->
						<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('bulksms/templates/delete/13');">
							<i class="el el-trash"></i>
						</a>
					</td>
					</tr>
			...
			<div class="row">
				<div class="col-sm-6">
					<section class="panel panel-pvs-shadow mt-lg">
						<header class="panel-heading panel-featured-primary pvs-heading-tran">
							<h2 class="panel-title">
								<i class="fa fa-envelope-open-o"></i> Message							</h2>
						</header>
						<div class="panel-body">
							<form action="bulksms/templates/make/" class="validate" id="frm" method="post" accept-charset="utf-8">
							<div class="form-group">
								<label class="control-label">
									Name <span class="required">*</span>
								</label>
								<input type="text" class="form-control" required title="Must Be Required" name="template_name"/>
							</div>
							<div class="form-group" id = 'has-error'>
								<label class="control-label">
									Message <span class="required">*</span>
								</label>
								<textarea name="template_description" data-plugin-summernote id="message_tags" class="summernote"></textarea>
				...
				<div class="col-sm-6">
					<section class="panel panel-pvs-shadow mt-lg">
						<header class="panel-heading panel-featured-primary pvs-heading-tran">
							<h2 class="panel-title">
								<i class="fa fa-tags" ></i> Tags							</h2>
						</header>
						<div class="panel-body">
							<div class="table-responsive">
								<table class="table table-bordered table-striped table-condensed mb-md mt-sm">
									<tbody>
										<tr>
											<td>
												Everyone											</td>
											<td>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{name}">{name}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{phone}">{phone}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{email}">{email}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{gender}">{gender}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{religion}">{religion}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{address}">{address}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{blood_group}">{blood_group}</button>
										...
										<tr>
											<td>
												Teacher											</td>
											<td>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{designation}">{designation}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{department}">{department}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{qualification}">{qualification}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{joining_date}">{joining_date}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{birthday}">{birthday}</button>
											</td>
										</tr>
										<tr>
											<td>
												Student											</td>
											<td>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{class}">{class}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{section}">{section}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{admission_date}">{admission_date}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{category}">{category}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{roll}">{roll}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{register_no}">{register_no}</button>
											</td>
										</tr>
										<tr>
											<td>
												Librarian / Accountant											</td>
											<td>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{joining_date}">{joining_date}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{birthday}">{birthday}</button>
											</td>
										...
										<tr>
											<td>
												Parents											</td>
											<td>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{father_name}">{father_name}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{father_occupation}">{father_occupation}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{mother_name}">{mother_name}</button>
												<button type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary msg_tags" value="{mother_occupation}">{mother_occupation}</button>
											</td>
										</tr>
									</tbody>
								</table>
							</div>
							<div class="alert alert-pvs mt-md">
								<strong>Important!</strong> If your message wants to include user information automatically, then you have to include tags in the place of user information.  You can select the warning tag, because there are different type user tags. You can use the <strong>"Everyone"</strong> tag for all type user templates.
							</div>
						</div>
					</section>
				</div>
...
<script type="text/javascript">
	...
	$('#frm').on('submit', function(e) {
		if($('#message_tags').summernote('isEmpty')) {
	...
	$( '.msg_tags' ).click( function () {
		var value = $( this ).val();
		$( "#message_tags" ).summernote( 'editor.saveRange' );
		$( "#message_tags" ).summernote( 'editor.restoreRange' );
		$( "#message_tags" ).summernote( 'editor.focus' );
		$( "#message_tags" ).summernote( 'editor.insertText', value );
