...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Invoice Edit | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary appear-animation" data-appear-animation="fadeInRight" data-appear-animation-delay="100">
				<form action="accounting/maintain/edit/317" class="validate" method="post" accept-charset="utf-8">
			<header class="panel-heading">
				<h2 class="panel-title">
					<i class="fa fa-credit-card-alt"></i> Invoice Edit				</h2>
			</header>
			<div class="panel-body">
				<div class="row mt-xs">
					<div class="col-sm-4">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="title" required value="fgdff"/>
						</div>
					</div>
					...
					<div class="col-sm-4">
						<div class="form-group">
							...
							title="Must Be Required" name="fees_id" onchange="fee_category(this.value)">
								<option value="">Select Fee Category</option>
																<option value="1" selected> Academic Fees </option>
				...
				<div class="row mt-sm">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="number" class="form-control" name="amount" id="amount" value="5000" required
				...
				<div class="row mt-sm">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" data-plugin-datepicker data-plugin-options='{ "todayHighlight" : true }' name="date"
							value="01/07/2019" 
							required title="Must Be Required"/>
						</div>
					</div>
				...
				<div class="row mt-lg mb-lg">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<select class="form-control" required data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" name="class_id"
							onchange="set_student(this.value)">
					...
					<div class="col-sm-6">
							...
							<select class="form-control" required title="Must Be Required" data-plugin-selectTwo data-width="100%" name="student_id" id="student_id">
								<option value="">Select Student</option>
																<option value="1" selected>Cherri Portnoy / Roll - 101</option>
																<option value="2" >Cherri Portnoy / Roll - 102</option>
																<option value="3" >Cherri Portnoy / Roll - 103</option>
																<option value="4" >Cherri Portnoy / Roll - 104</option>
																<option value="5" >Cherri Portnoy / Roll - 105</option>
																<option value="7" >Cherri Portnoy / Roll - 2017</option>
															</select>
						</div>
					</div>
				</div>
			...
			<div class="text-right">
				<div class="panel-footer">
					<button type="submit" class="btn btn-primary mr-xs">Update</button>
					<a href="accounting/invoice_history" class="btn btn-default">Cancel</a>
				</div>
			</div>
			</form>		</section>
...
<script type="text/javascript">
    function set_student(class_id) {
		$.ajax( {
			url: 'accounting/get_class_students/' + class_id,
