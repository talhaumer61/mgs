...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Grade Range Panel | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			<header class="panel-heading">
				<a href="#make_grade" class="modal-with-move-anim btn btn-primary btn-xs pull-right">
					<i class="fa fa-plus-square"></i> Make Grade				</a>
			...
			<div class="panel-body">
				<table class="table table-bordered table-striped mb-none table_default">
					...
					<tbody>
							...
							<td>
								<!-- UPDATE LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/exam/modal_grade_update.php?id=1');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('exam/grade/delete/1');">
							...
							<td>
								<!-- UPDATE LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/exam/modal_grade_update.php?id=2');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('exam/grade/delete/2');">
								<i class="el el-trash"></i>
								</a>
							</td>
						</tr>
							...
							<td>
								<!-- UPDATE LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/exam/modal_grade_update.php?id=3');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('exam/grade/delete/3');">
								<i class="el el-trash"></i>
								</a>
							</td>
						</tr>
							...
							<td>
								<!-- UPDATE LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/exam/modal_grade_update.php?id=4');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('exam/grade/delete/4');">
								<i class="el el-trash"></i>
								</a>
							</td>
						</tr>
							...
							<td>
								<!-- UPDATE LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/exam/modal_grade_update.php?id=5');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('exam/grade/delete/5');">
								<i class="el el-trash"></i>
								</a>
							</td>
						</tr>
							...
							<td>
								<!-- UPDATE LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/exam/modal_grade_update.php?id=6');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('exam/grade/delete/6');">
								<i class="el el-trash"></i>
								</a>
							</td>
						</tr>
							...
							<td>
								<!-- UPDATE LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/exam/modal_grade_update.php?id=7');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('exam/grade/delete/7');">
								<i class="el el-trash"></i>
								</a>
							</td>
						</tr>
		...
		<!-- Add Modal Box -->
		<div id="make_grade" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
			<div class="row">
				<div class="col-md-12">
					<section class="panel panel-featured panel-featured-primary">
						<form action="exam/grade/make" class="form-horizontal validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
