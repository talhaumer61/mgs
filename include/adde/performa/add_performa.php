	...
	<section class="panel panel-featured panel-featured-primary">
		<form action="performa.php" class="form-horizontal" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8" >
			...
			<div class="panel-body">
					...
					<div class="col-md-4 col-md-offset-4">
						...
						<select class="form-control" required title="Must Be Required" data-plugin-selectTwo data-width="100%" name="id_campus">
							...
							$sqllmsCamp	= $dblms->querylms("SELECT c.campus_id, c.campus_name, b.id_ad, b.id_de
																...
																AND (b.id_ad = '".$value_emp['emply_id']."' OR b.id_de = '".$value_emp['emply_id']."') AND b.is_deleted != '1' 
				...
				<br>
				<h5 class="text-danger">You can edit this performa <b><u>only one time</u></b> after submission </h5>';
											...
											<td>
												...
												<td class="center">
													<div class="form-group mb-md">
														<div class="col-md-6">
															<input type="number" class="form-control" name="rating['.$srnum.']" id="rating['.$srnum.']" required title="Must be between 0 to 5" min="0" max="5">
														</div>
													</div>	
													<!--
