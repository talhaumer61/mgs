...
if(($_SESSION['userlogininfo']['LOGINIDA'] == 1) ||($_SESSION['userlogininfo']['LOGINTYPE']  == 2) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '13', 'added' => '1'))){
	echo '
	<a href="timetable_classroom.php?view=add" class="btn btn-primary btn-xs pull-right mr-sm">
...
if(($_SESSION['userlogininfo']['LOGINIDA'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE']  == 2)){
	echo '
...
if(($_SESSION['userlogininfo']['LOGINIDA'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE']  == 2)){
	echo '
	<td>
		<a href="timetable_classroom.php?id='.$rowsvalues['id'].'" class="btn btn-primary btn-xs" onclick=""><i class="glyphicon glyphicon-edit"></i></a>
