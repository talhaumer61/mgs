...
echo '			</select>
	...
	<div class="col-md-6">
		<div class="form-group">
			<label class="control-label">Admin <span class="required">*</span></label>
			...
			<option value="">Select</option>';
				$sqllmscls	= $dblms->querylms("SELECT campus_id, campus_status, campus_name 
					 ...
					 while($sqllmscls = mysqli_fetch_array($sqllmscls)) {
						  if($sqllmscls['campus_id'] == $sqllmscls['id_campus']) { 
							  echo '<option value="'.$sqllmscls['campus_id'].'" selected>'.$sqllmscls['campus_name'].'</option>';
						  } else { 
							  echo '<option value="'.$sqllmscls['campus_id'].'">'.$sqllmscls['campus_name'].'</option>';
						  }
					  }
			  echo '
		</select>
...
<div class="col-lg-12 heading-modal" style="margin-top:5px; margin-bottom:5px;"><input id="checkall" name="checkall" type="checkbox" class="checkbox-inline"> Full Rights</div>
...
//------------------------------------------------
	...
	if($rowsadmvalue['reporting'] == 1) { $viewchecked 	= ' checked="checked"'; } else { $viewchecked 	= ''; }
//------------------------------------------------
echo '
	<div class="col-sm-41">
		...
		<div class="col-sm-3">
			...
			<input id="reporting_'.$sri.'"  name="reporting['.$sri.']" type="checkbox" value="1" '.$viewchecked.' class="checkbox-inline role_'.$kij.' roleb_'.$sri.'"> View
		</div>
		</div> 
	</div>';
//----------------------------
...
echo '
	<div class="col-sm-41">
		...
		<div class="col-sm-3">
			...
			<input id="reporting_'.$sri.'"  name="reporting['.$sri.']" type="checkbox" value="1" class="checkbox-inline role_'.$kij.' roleb_'.$sri.'"> Reporting
		</div> 
		</div>
	</div>';
}
