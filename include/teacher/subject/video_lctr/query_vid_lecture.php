<?php 
// INSERT RECORD
if(isset($_POST['submit_video_lecture'])){
	...
	if(mysqli_num_rows($sqllmscheck)){
		...
		if($sqllms){
			...
			$sqllmslog  = $dblms->querylms("INSERT INTO ".LOGS." (
										...
										");
		    $ref = '?id='.$_POST['id_subject'].'&section='.$_POST['id_section'].'&class='.$_POST['id_class'].'&view=video_lctr';
...
// UPDATE RECORD
if(isset($_POST['changes_video_lecture'])){
	...
	if(mysqli_num_rows($sqllmscheck)){
		...
		if($sqllms){
			...
			$sqllmslog  = $dblms->querylms("INSERT INTO ".LOGS." (
									...
									");
			$ref = '?id='.$_GET['id'].'&section='.$_GET['section'].'&class='.$_GET['class'].'&view=video_lctr';	
			$_SESSION['msg']['title'] 	= 'Successfully';
