...
<header class="panel-heading">
	<a href="#make_transport" class="modal-with-move-anim btn btn-primary btn-xs pull-right">
...
<tr>
	...
	<td>
		<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom(\'include/modals/transport/vehicles/update_vehicles.php?id='.$rowsvalues['vehicle_id'].'\');"><i class="glyphicon glyphicon-edit"></i> Edit</a>
