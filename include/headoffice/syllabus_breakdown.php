...
if(($_SESSION['userlogininfo']['LOGINTYPE']  == 1) || (arrayKeyValueSearch($_SESSION['userroles'], 'right_name', '57'))){
	...
	require_once("syllabus-breakdown/query_syllabus.php");
	echo'
	...
	<section role="main" class="content-body">
		...
		<div class="row">
			<div class="col-md-12">';
				...
				include_once("include/modals/syllabus-breakdown/modal_syllabus_add.php");
				echo'
			</div>
		</div>';
	?>
	<script type="text/javascript">
		...
		function get_classsubject(id_class,syllabus_breakdown) {  
			// $("#loading").html('<img src="images/ajax-loader-horizintal.gif"> loading...');  
			$.ajax({  
				type: "POST",  
				url: "include/ajax/get_classsubject.php",  
				data: "id_class="+id_class+"&syllabus_breakdown="+syllabus_breakdown,  
