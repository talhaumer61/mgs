...
<aside id="sidebar-left" class="sidebar-left" style="padding-bottom:50px;">
	...
	<div class="nano">
		<div class="nano-content">
			...
			<li class="nav-parent  ">
				...
				<ul class="nav nav-children">
					...
					<li class="nav-parent  ">
						...
						<ul class="nav nav-children">
							<li class=" "><a href="royaltyChallans.php">Royalty Challans</a></li>
							<li class=" "><a href="royaltyParticulars.php">Royalty Paticulars</a></li>
						</ul>
					</li>
			...
			if(($_SESSION['userlogininfo']['LOGINTYPE']  == 1) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('type' => '82')) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('type' => '83')) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('type' => '84'))){ 
				echo'
				<li class="nav-parent  ">
					<a>
			...
			<li class="nav-parent">
				...
				<ul class="nav nav-children" style="overflow: auto;">';
					...
					<li class=""><a href="campus_group.php"><i class="fa fa-genderless" aria-hidden="true"></i>Camopus Groups</a></li>
				...
				<ul class="nav nav-children">
					<li class="nav-parent">
						...
						<ul class="nav nav-children">
							...
							<li class=" "><a href="city.php"><span>City</span></a></li>
						</ul>
					</li>
