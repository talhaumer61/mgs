...
<section class="panel panel-featured panel-featured-primary">
	<header class="panel-heading">';
		if(($_SESSION['userlogininfo']['LOGINTYPE']  == 1) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '62', 'add' => '1'))){ 
			...
			<i class="fa fa-plus-square"></i> Make Vacational Engagement Task
			</a>';
		}
		echo'
	...
	<div class="panel-body">
							...
							<div class="dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">';
									...
									if(($_SESSION['userlogininfo']['LOGINTYPE']  == 1) ||  Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '57', 'edit' => '1'))){ 
										echo'<li><a href="#show_modal" class="modal-with-move-anim-pvs dropdown-item" onclick="showAjaxModalZoom(\'include/modals/summer-work/modal_summer_update.php?id='.$rowsvalues['summer_id'].'\');"><i class="fa fa-edit"></i> Edit</a></li>';
									}
									if(($_SESSION['userlogininfo']['LOGINTYPE']  == 1) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '57', 'delete' => '1'))){ 
										echo'<li><a href="#" class="dropdown-item" onclick="confirm_modal(\'summer-work.php?deleteid='.$rowsvalues['summer_id'].'\');"><i class="fa fa-trash"></i> Delete</a></li>';
									}
									echo'
								</div>
							</div>
		...
		// 				<td class="center">'.get_status($rowsvalues['summer_status']).'</td>
		...
		// 				echo '<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs ml-xs" onclick="showAjaxModalZoom(\'include/modals/summer-work/modal_summer_update.php?id='.$rowsvalues['summer_id'].'\');"><i class="glyphicon glyphicon-edit"></i></a>';
		// 				}
		// 				if(($_SESSION['userlogininfo']['LOGINTYPE']  == 1) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '62', 'delete' => '1'))){ 
		// 				echo'
