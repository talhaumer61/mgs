...
if(isset($_POST['submit_syllabus'])){ 
	...
	if(!empty($_FILES['syllabus_file']['name'])) { 
		...
		$originalImage	= $img_dir.to_seo_url(cleanvars($_POST['id_session'].'-'.$_POST['id_class'])).'-'.$syllabus_id.".".($extension);
		$img_fileName	= to_seo_url(cleanvars($_POST['id_session'].'-'.$_POST['id_class'])).'-'.$syllabus_id.".".($extension);
	...
	if(!empty($_FILES['file_thumbnail']['name'])) { 
		...
		$extension		= strtolower($path_parts['extension']);
		$img_dir 		= 'uploads/syllabus/thumbnail/';
		$originalImage	= $img_dir.to_seo_url('thumb-'.$_POST['id_session'].'-'.$_POST['id_class'].'-'.$syllabus_id.".".($extension));
		$img_fileName	= to_seo_url('thumb-'.$_POST['id_session'].'-'.$_POST['id_class'].'-'.$syllabus_id.".".($extension));
