...
if(isset($_POST['submit_syllabus'])){
	...
	if(mysqli_num_rows($sqllmscheck)){
		...
		if(!empty($_FILES['syllabus_file']['name'])) { 
			...
			$originalImage	= $img_dir.to_seo_url($_POST['id_session'].'-'.get_monthtypes($_POST['id_month']).'-'.$_POST['id_class'].'-'.$syllabus_id).".".($extension);
			$img_fileName	= to_seo_url($_POST['id_session'].'-'.get_monthtypes($_POST['id_month']).'-'.$_POST['id_class'].'-'.$syllabus_id).".".($extension);
		...
		if(!empty($_FILES['file_thumbnail']['name'])) { 
			...
			$extension 		= strtolower($path_parts['extension']);
			$img_dir		= 'uploads/worksheet/thumbnail/';
			$originalImage	= $img_dir.to_seo_url('thumb-'.$_POST['id_session'].'-'.get_monthtypes($_POST['id_month']).'-'.$_POST['id_class'].'-'.$syllabus_id).".".($extension);
			$img_fileName	= to_seo_url('thumb-'.$_POST['id_session'].'-'.get_monthtypes($_POST['id_month']).'-'.$_POST['id_class'].'-'.$syllabus_id).".".($extension);
