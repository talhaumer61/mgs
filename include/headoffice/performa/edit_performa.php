	...
	<section class="panel panel-featured panel-featured-primary">
			<form action="performa.php" class="form-horizontal" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8" >
				...
				<div class="panel-body">
					...
					<input type="hidden" name="visit_month" value="'.$valuePerforma['visit_month'].'">
						...
						<div class="col-md-4 col-md-offset-4">
							...
							<select class="form-control" required title="Must Be Required" data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" name="id_campus" disabled>
								...
								echo '  <option value="'.$valuecls['campus_id'].'" 
											'.(($valuePerforma['id_campus'] == $valuecls['campus_id'] ) 
												? 'selected' 
												: '' ).' 
										>
							...
							<div class="col-md-4 col-md-offset-4">
								...
								foreach($statusLeave as $status){
									...
									<div class="radio-custom radio-inline">
										<input type="radio" id="status" name="status" ';if($valuePerforma['status'] == $status['id']){echo ' checked';} echo' value="'.$status['id'].'">
									...
									<tr>
										...
										<td class="center">
											<div class="form-group mb-md">
												<div class="col-md-6">
													<input type="number" class="form-control text-center" name="rating['.$srnum.']" id="rating['.$srnum.']" value="'.$rowsvalues['rating'].'" required title="Must Be Required" min="0" max="5" >
												</div>
											</div>	
											...
											<div class="form-group">
												<div class="col-md-12">
													<div class="checkbox-custom checkbox-inline">
														<input type="checkbox" name="is_applicable['.$srnum.']" ';if($rowsvalues['is_applicable']== 2){echo ' checked';} echo' >
