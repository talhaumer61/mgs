            ...
            <div class="panel-body">
                <div class="form-group">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" data-plugin-selectTwo data-width="100%" name="id_ad">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" data-plugin-selectTwo data-width="100%" name="id_de">
                            <option value="">Select</option>';
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="covered_area" id="covered_area" value="'.$rowsvalues['covered_area'].'"/>
                    </div>
                </div>
                <div class="form-group mt-sm">
                    <div class="col-md-4">
                        <label class="control-label"> Total Rooms</label>
                        <input type="text" class="form-control" name="total_rooms" id="total_rooms" value="'.$rowsvalues['total_rooms'].'"/>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="form-group mt-sm">
                    ...
                    <div class="col-md-6">
                        <label class="control-label"> Date of Establishment <span class="required">*</span></label>
                ...
                <div class="form-group mt-sm">
                    <div class="col-md-4">
                        <label class="control-label"> Principal Phone Number <span class="required">*</span></label>
                    ...
                    <div class="col-md-4">
                        <label class="control-label"> School Phone Number </label>
                ...
                <div class="form-group">
                    <div class="col-md-6">
                        <label class="control-label"> Bank-1 Name</label>
                        <select class="form-control" data-plugin-selectTwo data-width="100%" name="primary_bank" id="primary_bank">
                            <option value="">Select</option>';
                    ...
                    <div class="col-md-6">
                        <label class="control-label"> Bank-1 Account</label>
                        <input type="text" class="form-control" name="primary_account" id="primary_account" value="'.$rowsvalues['primary_account'].'"/>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-6">
                        <label class="control-label"> Bank-2 Name</label>
                        <select class="form-control" data-plugin-selectTwo data-width="100%"  name="secondary_bank" id="secondary_bank">
                            <option value="">Select</option>';
                            foreach($banklist as $bank) {
                    ...
                    <div class="col-md-6">
                        <label class="control-label">  Bank-2 Account </label>
                        <input type="text" class="form-control" name="secondary_account" id="secondary_account" value="'.$rowsvalues['secondary_account'].'"/>
                    </div>
                </div>
                <div class="form-group mb-md">
                    <div class="col-md-6">
                        <label class="control-label"> MEC President Name></label>
                        <input type="text" class="form-control" name="mec_president" id="mec_president" value="'.$rowsvalues['mec_president'].'"/>
                    </div>
                    <div class="col-md-6">
                        <label class="control-label">MEC President Number></label>
                        <input type="text" class="form-control" name="mec_president_no" id="mec_president_no" value="'.$rowsvalues['mec_president_no'].'"/>
                    </div>
                </div>
            </div>
        </fieldset>
