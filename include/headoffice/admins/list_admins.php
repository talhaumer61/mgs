...
<section class="panel panel-featured panel-featured-primary">
	...
	<div class="panel-body">
		<table class="table table-bordered table-striped table-condensed mb-none" id = "table_export">
			<thead>
				<tr>
					<th style="text-align:center;" width="50">Sr.</th>
			...
			<tbody>';
				$sqllms	= $dblms->querylms("SELECT a.adm_id, a.adm_status, a.adm_type, a.adm_username, a.adm_fullname,
												...
												FROM ".ADMINS." a  
												WHERE a.adm_logintype = '1' 
												AND a.adm_id != '".cleanvars($_SESSION['userlogininfo']['LOGINIDA'])."'
												AND a.is_deleted = '0'
				...
				while($rowsvalues = mysqli_fetch_array($sqllms)) {
					...
					<tr>
						...
						<td>
							<a href="admins.php?id='.$rowsvalues['adm_id'].'" class="btn btn-primary btn-xs""><i class="glyphicon glyphicon-edit"></i></a>

							<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom(\'include/modals/headoffice/change_pass.php?id='.$rowsvalues['adm_id'].'\');"><i class="glyphicon glyphicon-lock"></i></a>
