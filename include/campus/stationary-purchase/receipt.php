...
if(($_SESSION['userlogininfo']['LOGINAFOR'] == 1 && $_SESSION['userlogininfo']['LOGINTYPE'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE'] == '1' && in_array('52', $_SESSION['userlogininfo']['PERMISSIONS'])) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '52', 'view' => '1'))) {
    if(isset($_GET['pr'])){
        $sqllms	= $dblms->querylms("SELECT pur_id, pur_status, pur_pay_status, pur_pay_invoice, pur_receipt_no, pur_total_amount, pur_paid_amount, pur_payable, dated, pur_note	 
                                        FROM ".INVENTORY_PURCHASE."
                                        WHERE id_campus = '".$_SESSION['userlogininfo']['LOGINCAMPUS']."' AND pur_id='".$_GET['pr']."' ");
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 text-right mt-md mb-md">
                                <address class="ib mr-xlg">
                                    ...
                                    Payment : '.get_payments($rowsvalues['pur_pay_status']).' <br>
                                    Status : '.get_delivery($rowsvalues['pur_status']).'  
                                </address>
                                <div class="ib">
                                    <img src="'.$_SESSION['userlogininfo']['LOGINCAMPUSLOGO'].'" width="70" height="70" alt="'.TITLE_HEADER.'">
                                </div>
                            </div>
                        </div>
                    </header>';
                                ...
                                <table class="table h5 text-dark">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left">Rs. '.$rowsvalues['pur_paid_amount'].'</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">Payable Amount</td>
                                            <td class="text-left">Rs. '.$rowsvalues['pur_payable'].'</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
