		...
		if($dblms->getRows(EXAM_MARKS, $condition)) {	
			...
			$condition = array(
								...
								,'where'        =>  array(
															...
															,'ea.id_exam'		=>	cleanvars($id_exam)
															,'ea.id_class'		=>	cleanvars($id_class)
															,'ea.id_section'	=>	cleanvars($id_section)
															,'ea.id_subject'	=>	cleanvars($id_subject)
														)
				...
				<section class="panel panel-featured panel-featured-primary">
					<form action="'.moduleName().'.php" class="mb-lg validate" enctype="multipart/form-data" method="post" accept-charset="utf-8" autocomplete="off">
						<header class="panel-heading"">
							<h4 class="panel-title"><i class="fa fa-plus-square"></i> Add Marks</h4>
						</header>
						<div class="panel-body">
							...
							<table class="table table-bordered table-striped table-condensed mb-none">
								<thead>
									<tr>
										...
										<th width="80" class="text-center">Obtained</th>
									...
									foreach ($EXAM_ATTENDANCE as $key => $student) {
										...
										<tr>
											...
											<td class="text-center">
												...
												<input type="hidden" class="form-control" value="'.$DATESHEET['total_marks'].'" name="total_marks['.$srno.']" id="total_marks_'.$srno.'" required readonly>
											</td>
											<td class="text-center">
												<div>
													<input type="number" class="form-control" name="obtain_marks['.$srno.']" id="obtain_marks_'.$srno.'" max="'.$DATESHEET['total_marks'].'" required>
												</div>
											</td>
											<td>
						...
						<footer class="panel-footer">
							<div class="row">
								<div class="col-md-12 text-right">
									<button type="submit" id="submit" name="submit_marks" class="mr-xs btn btn-primary">Add Marks</button>
