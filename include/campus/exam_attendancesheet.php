...
if(($_SESSION['userlogininfo']['LOGINTYPE'] == '1' && in_array('12', $_SESSION['userlogininfo']['PERMISSIONS'])) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '12', 'view' => '1'))) {
	...
	echo'
	<title> Exam Attendance Sheet Panel | '.TITLE_HEADER.'</title>
	<section role="main" class="content-body">
		<header class="page-header">
			<h2>Attendance Sheet Panel </h2>
		</header>
		<div class="row">
			<div class="col-md-12">';
					include_once("exam_attendancesheet/list.php");
				echo '
			</div>
		</div>
	</section>';
		...
		$("#id_exam").change(function(){
			...
			$.ajax({  
				...
				data: {
					 "id_exam"		: id_exam
					,"id_campus"	: id_campus
					,"method"		: "attendance_marked_classes"
				},
				success: function(msg){
					console.log(id_exam);
					$("#id_class").html(msg);
