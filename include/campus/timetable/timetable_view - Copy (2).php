...
//-----------------------------------------------------
$sqllmstimetable	= $dblms->querylms("SELECT t.id, t.status, t.id_session, t.id_class, t.id_section, t.id_campus,
								   ...
								   WHERE t.id_class = '".$clss."'
								   AND t.id_section = '".$sction."' AND t.id_campus = '".$_SESSION['userlogininfo']['LOGINCAMPUS']."' 
								   LIMIT 1");
$rowsvalues = mysqli_fetch_array($sqllmstimetable);
//-----------------------------------------------------
	echo '
    <header class="panel-heading">
