...
if(($_SESSION['userlogininfo']['LOGINTYPE'] == 1) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '12', 'view' => '1'))){
	...
	<section class="panel panel-featured panel-featured-primary">
		<header class="panel-heading">
			<h2 class="panel-title"><i class="fa fa-list"></i> Attendance Sheet Print</h2>
		</header>
		<div class="panel-body">
			<form method="POST" action="exam_attendancesheet_print.php" target="_blank">
				<div class="row">';
				...
				<div class="row">
					<div class="col-md-12 text-center mt-sm">
						<button type="submit" name="view_details" class="mr-xs btn btn-primary"><i class="glyphicon glyphicon-print"></i> Print Attendance Sheet</button>
					</div>
				</div>
			</form>
		</div>
