...
if(($_SESSION['userlogininfo']['LOGINAFOR'] == 1 && $_SESSION['userlogininfo']['LOGINTYPE'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE'] == '1' && in_array('54', $_SESSION['userlogininfo']['PERMISSIONS'])) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '54', 'add' => '1'))) {
    $sqllms_sal	= $dblms->querylms("SELECT count(sal_id) as sales  FROM ".INVENTORY_SALE."  WHERE id_campus = '".$_SESSION['userlogininfo']['LOGINCAMPUS']."'");
    $value_sal = mysqli_fetch_array($sqllms_sal);

    $date = date("Y-m-d");
    $sale_no = $value_sal['sales'] + 1;
    $receipt_no = $_SESSION['userlogininfo']['LOGINCAMPUS']."-".$sale_no." ";
    echo'
    <form action="stationary_sale.php" class="validate" method="post" accept-charset="utf-8" novalidate="novalidate">
        <section class="panel panel-featured panel-featured-primary appear-animation fadeInRight appear-animation-visible" data-appear-animation="fadeInRight" data-appear-animation-delay="100" style="animation-delay: 100ms;">
            <header class="panel-heading">
                <h2 class="panel-title"><i class="fa fa-plus-square"></i> Make Sale</h2>
            </header>
                            ...
                            <div class="panel-body">
                                <div class="row addline">
                                    <div class="col-sm-3 mt-md">
                                        <select data-width="100%" id="id_item" name="id_item[]" class="form-control id_item" required title="Must Be Required" onchange="get_itemprice(this.value)">
                                        ...
                                        <tr class="b-top-none">
                                            ...
                                            <td class="text-left">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="receipt_no" readonly="" value="'.$receipt_no.'">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr class="b-top-none">
                                        ...
                                        <tr class="h4">
                                            ...
                                            <td class="text-left">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="sal_total_amount" readonly="" id="total_amount" value="0">
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
            ...
            <div class="panel-footer text-right">
                <button type="submit" id="make_sale" name="make_sale" class="btn btn-primary"> Confirm Sale </button>
            </div>
        </section>
    </form>';
    ?>
