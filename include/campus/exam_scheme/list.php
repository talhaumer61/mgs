<?php 
if(($_SESSION['userlogininfo']['LOGINTYPE'] == '1' && in_array('81', $_SESSION['userlogininfo']['PERMISSIONS'])) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '81', 'view' => '1'))) {
	echo'
	<section class="panel panel-featured panel-featured-primary">
		<header class="panel-heading">';
			if(($_SESSION['userlogininfo']['CAMPUSTYPE']  == 1)){ 
				echo'<a href="#make_scheme" class="modal-with-move-anim btn btn-primary btn-xs pull-right"><i class="fa fa-plus-square"></i> Make Assessment Scheme</a>';
			}
			echo'
						...
						<tr>
							...
							<td width="120px" class="center">';
								...
								if(($_SESSION['userlogininfo']['CAMPUSTYPE']  == 1)){
									...
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal(\'exam_scheme.php?deleteid='.$rowsvalues['id'].'\');"><i class="el el-trash"></i></a>';
								}
								echo '
							</td>
						</tr>';
