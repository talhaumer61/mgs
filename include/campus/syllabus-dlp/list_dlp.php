<?php 
if(($_SESSION['userlogininfo']['LOGINTYPE'] == '1' && in_array('59', $_SESSION['userlogininfo']['PERMISSIONS'])) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '59', 'view' => '1'))) { 
	echo'
	<section class="panel panel-featured panel-featured-primary">
		...
		<div class="panel-body">
			...
			// 			<th class="center">#</th>
			// 			<th>Term</th>
			// 			<th width="70px;" class="center">Month</th>
			// 			<th width="70px;" class="center">Week</th>
			// 			<th>Class</th>
			// 			<th>Subject</th>
			...
			// 				<td class="center">'.get_week($rowsvalues['id_week']).'</td>
