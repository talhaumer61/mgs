...
if(($_SESSION['userlogininfo']['LOGINTYPE'] == 1) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '12', 'view' => '1'))){
	...
	<section class="panel panel-featured panel-featured-primary">
		<header class="panel-heading">
			<a href="'.moduleName().'.php?view=add" class="btn btn-primary btn-xs pull-right"><i class="fa fa-plus-square"></i> Mark Attendance</a>
		...
		<div class="panel-body">
			<table class="table table-bordered table-striped table-condensed mb-none" id="table_export">
				...
				<tbody>';
					$condition = array(
											 'select'       =>  'et.*, t.type_name, c.class_name, cs.section_name, sb.subject_name, et.is_publish'
											,'join'			=>	'INNER JOIN '.EXAM_TYPES.' t ON t.type_id = et.id_exam AND t.id_campus = '.($_SESSION['userlogininfo']['CAMPUSTYPE']  == 1 ? $_SESSION['userlogininfo']['LOGINCAMPUS'] : $_SESSION['userlogininfo']['PARENTCAMPUS']).' AND t.is_deleted = 0
					...
					foreach ($EXAM_ATTENDANCE as $key => $value) {
						...
						<tr>
							...
							<td class="center">';
								if($_SESSION['userlogininfo']['CAMPUSTYPE'] == 1 || $value['is_publish'] != 1){
									echo'
