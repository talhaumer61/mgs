			  ...
			  <form action="#" class="form-horizontal" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8" >
				...
				<div class="panel-body">
					  ...
					  <div class="form-group mt-sm">
						  <label class="col-md-2 control-label">Reg no <span class="required">*</span></label>
						  <div class="col-md-9">
							  <input type="text" class="form-control" name="regno" id="regno" onchange="get_getstudentdatabyregno(this.value)" required title="Must Be Required"/>
						  </div>
					  </div>					
					  ...
					  <div class="form-group mt-sm">
					<label class="col-md-2 control-label">Student <span class="required">*</span></label>
					<div class="col-md-9">
