		...
		<form action="examgradingsystem.php" class="form-horizontal" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
			...
			<div class="panel-body">
				...
				<div class="form-group mb-md">
					...
					<div class="col-md-9">
						<input type="text" class="form-control" name = "grade_point" id="grade_point"></textarea>
					</div>
				</div>

				<div class="form-group mb-md">
					<label class="col-md-3 control-label">Grade Lower Mark</label>
					<div class="col-md-9">
						<input type="text" class="form-control" name = "grade_lowermark" id="grade_lowermark">
					</div>
				</div>
				
				<div class="form-group mb-md">
					<label class="col-md-3 control-label">Grade Upper Mark</label>
					<div class="col-md-9">
						<input type="text" class="form-control" name = "grade_uppermark" id="grade_uppermark">
					</div>
				</div>				

				<div class="form-group mb-md">
					<label class="col-md-3 control-label">Grade Comment</label>
					<div class="col-md-9">
						<input type="text" class="form-control" name = "grade_comment" id="grade_comment">
					</div>
				</div>
