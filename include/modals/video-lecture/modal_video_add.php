<?php 
// if(($_SESSION['userlogininfo']['LOGINTYPE']  == 3) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '63', 'add' => '1'))){ 
echo '
<!-- Add Modal Box -->
<div id="make_video_lecture" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
		...
		<form action="#" class="form-horizontal" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
			...
			<div id="getclasssubject">
				<div class="form-group  mb-md">
					...
					<div class="col-md-9">
						<select class="form-control" required title="Must Be Required" data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" id="id_subject" name="id_subject">
							<option value="">Select</option>';
