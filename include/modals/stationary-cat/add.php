<?php 
if(($_SESSION['userlogininfo']['LOGINTYPE']  == 1) || (arrayKeyValueSearch($_SESSION['userroles'], 'right_name', '40')) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '33', 'view' => '1'))){ 
echo '
<!-- Add Modal Box -->
	...
	<section class="panel panel-featured panel-featured-primary">
		<form action="stationary_category.php" class="form-horizontal" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
			<header class="panel-heading">
				<h2 class="panel-title"><i class="fa fa-plus-square"></i>  Make Stationary Category</h2>
			</header>
