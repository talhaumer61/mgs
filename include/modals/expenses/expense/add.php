...
echo '
<!-- Add Modal Box -->
<div id="make_expense" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
	<section class="panel panel-featured panel-featured-primary">
		<form action="expenses.php" class="form-horizontal" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
			<header class="panel-heading">
				<h2 class="panel-title"><i class="fa fa-plus-square"></i>  Make Expense</h2>
			</header>
			<div class="panel-body">
				...
				<div class="form-group">
					<label class="col-md-3 control-label">Expense Name <span class="required">*</span></label>
					<div class="col-md-9">
			...
			<footer class="panel-footer">
				<div class="row">
					<div class="col-md-12 text-right">
						<button type="submit" class="btn btn-primary" id="submit_expense" name="submit_expense">Save</button>
