	...
	<section class="panel panel-featured panel-featured-primary">
		<form action="student_behaviour_roles.php" class="form-horizontal" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
			<header class="panel-heading">
				<h2 class="panel-title"><i class="fa fa-plus-square"></i>  Make Behaviour Role</h2>
			</header>
			<div class="panel-body">
				...
				<div class="form-group mb-md">
					...
					<div class="col-md-9">
						<textarea class="form-control" rows="2" name="role_detail" id="role_detail"></textarea>
					</div>
				</div>
			...
			<footer class="panel-footer">
				<div class="row">
					<div class="col-md-12 text-right">
						<button type="submit" class="btn btn-primary" id="submit_role" name="submit_role">Save</button>
