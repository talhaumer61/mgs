...
//---------------------------------------------------------
//---------------------------------------------------------
$sqllms	= $dblms->querylms("SELECT adm_id, adm_username, adm_fullname
FROM ".ADMINS." 
...
<div class="row">
    <div class="col-md-12">
        <section class="panel panel-featured panel-featured-primary">
            <form action="campuslogin.php" class="form-horizontal" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8" autocomplete="off">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group mb-sm">
                        ...
                        <div class="col-md-9">
                            <input type="password" class="form-control" name="adm_pass" id="adm_pass" required title="Must Be Required" />
                        </div>
                    </div>
                </div>
