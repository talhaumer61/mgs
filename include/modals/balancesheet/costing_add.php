...
if(($_SESSION['userlogininfo']['LOGINTYPE'] == '1' && in_array('29', $_SESSION['userlogininfo']['PERMISSIONS'])) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '29', 'add' => '1'))) {
    echo'
    <div id="make_costing" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
        <section class="panel panel-featured panel-featured-primary">
            <form action="costing.php" class="form-horizontal validate" method="post" enctype="multipart/form-data" accept-charset="utf-8" novalidate="novalidate" >
                <div class="panel-heading">
                    <h4 class="panel-title"><i class="fa fa-plus-square"></i> Make Expense Voucher</h4>
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Receipt<span class="required" aria-required="true">*</span></label>
                        <div class="col-sm-9">
                            <input type="file" class="form-control" name="receipt_image" accept="image/*" required title="Must Be Required"/>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <footer class="panel-footer">
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <button type="submit" id="submit_costing" name="submit_costing" class="btn btn-primary">Save</button>
