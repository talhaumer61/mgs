		...
		<section class="panel panel-featured panel-featured-primary">
			<form action="costinghead.php" class="form-horizontal" id="form" method="post" accept-charset="utf-8">
				<header class="panel-heading">
					<h2 class="panel-title"><i class="fa fa-plus-square"></i> Add Expense Head</h2>
				</header>
				...
				<footer class="panel-footer">
					<div class="row">
						<div class="col-md-12 text-right">
							<button type="submit" class="btn btn-primary" id="submit_costing_head" name="submit_costing_head">Save</button>
