...
if(($_SESSION['userlogininfo']['LOGINTYPE']  == 1) || ($_SESSION['userlogininfo']['LOGINTYPE']  == 2) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '72', 'edit' => '1'))){
			...
			<form action="scholarship_category.php" class="form-horizontal" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="hidden" name="cat_id" id="cat_id" value="'.cleanvars($rowsvalues['cat_id']).'">
