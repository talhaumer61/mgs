<?php 
if(($_SESSION['userlogininfo']['LOGINTYPE']  == 1) || ($_SESSION['userlogininfo']['LOGINIDA'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE']  == 2) || ($_SESSION['userlogininfo']['LOGINIDA'] == 2) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '65', 'added' => '1')))
{
echo '
<!-- Add Modal Box -->
	...
	<section class="panel panel-featured panel-featured-primary">
		<form action="postaldispatch.php" class="form-horizontal" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
			<header class="panel-heading">
				<h2 class="panel-title"><i class="fa fa-plus-square"></i>  Add Dispatch</h2>
			</header>
			<div class="panel-body">
				<div class="form-group mt-sm">
					<label class="col-md-3 control-label">To Title <span class="required">*</span></label>
					<div class="col-md-9">
						<input type="text" class="form-control" name="to_title" id="to_title" required title="Must Be Required"/>
					</div>
				</div>
				...
				<div class="form-group mb-md">
					...
					<div class="col-md-9">
						<input type="text" class="form-control" name = "to_phone" id="to_phone" required title="Must Be Required"/>
					</div>
				</div>
				...
				<div class="form-group mb-md">
					...
					<div class="col-md-9">
						<input type="text" class="form-control" name = "to_email" id="to_email" required title="Must Be Required"/>
					</div>
				</div>
				...
				<div class="form-group mb-md">
					...
					<div class="col-md-9">
						<input type="text" class="form-control" name = "reference_no" id="reference_no" required title="Must Be Required"/>
					</div>
				</div>
				...
				<div class="form-group mb-md">
					...
					<div class="col-md-9">
						<input type="file" class="form-control" name = "attachment" id="attachment" required title="Must Be Required"/>
					</div>
				</div>
			...
			<footer class="panel-footer">
				<div class="row">
					<div class="col-md-12 text-right">
						<button type="submit" class="btn btn-primary" id="submit_postaldispatch" name="submit_postaldispatch">Save</button>
