<?php 
if(($_SESSION['userlogininfo']['LOGINAFOR'] == 1 && $_SESSION['userlogininfo']['LOGINTYPE'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE'] == '1' && in_array('34', $_SESSION['userlogininfo']['PERMISSIONS'])) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '34', 'add' => '1'))) {
  	echo'
	<div id="make_item" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
		<section class="panel panel-featured panel-featured-primary">
			<form action="stationary_item.php" class="form-horizontal" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				<header class="panel-heading">
					<h2 class="panel-title"><i class="fa fa-plus-square"></i>  Make Stationary Item</h2>
				</header>
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="number" class="form-control" rows="3" name="school_price" id="school_price"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label">School Price <span class="required">*</span></label>
						<div class="col-md-9">
							<input type="number" class="form-control" rows="3" name= "std_price" id="std_price"/>
						</div>
					</div>
