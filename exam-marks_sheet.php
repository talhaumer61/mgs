...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Marks Sheet | Rudras School</title>
...
<div class="row">
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
		<form action="exam/marks_sheet" id="form" method="post" accept-charset="utf-8">
			<header class="panel-heading">
			...
			<div class="panel-body">
				<div class="row mb-sm">
					<div class="col-md-4">
						...
						<label class="control-label">Exam <span class="required">*</span></label>
							<select name="exam_id" class="form-control" required title="Must Be Required" data-plugin-selectTwo data-width="100%" 
					...
					<div class="col-md-4 mb-sm">
						<div class="form-group">
							...
							<select name="class_id" class="form-control" required title="Must Be Required" onchange="get_class_section(this.value)"
				...
				<header class="panel-heading">
					<h2 class="panel-title">
						<i class="fa fa-users"></i> <span class="hidden-xs">Class One ( Section A )</span>
						Students List					</h2>
				</header>
				<div class="panel-body">
								...
								<tr>
									<td class="center">
										...
										Subjects <i class="fa fa-hand-o-right"></i>
																		...
																		<td class="center">Bangla</td>
																		<td class="center">Computer</td>
																		<td class="center">Mathematics</td>
																		<td class="center">Grand Total</td>
									<td class="center">Average Grade Point</td>
									<td class="hidden-xs hidden-sm center" width="20%">Percent</td>
							...
							<tbody>
									...
									<td class="center">
										...
										66									</td>
																		<td class="center">
										60									</td>
																		<td class="center">246 / 400</td>
									<td class="center">
										3.5									</td>
									<td class="hidden-xs hidden-sm center">
											<div class="progress progress-lg progress-squared light" style="margin: 6px;">
												<div class="progress-bar" role="progressbar" aria-valuenow="61.5" aria-valuemin="0" aria-valuemax="100" style="width: 61.5%;">
												61.5 %
                                              </div>
											</div>
									</td>
									...
									<td class="center">
										...
										77									</td>
																		<td class="center">
										77									</td>
																		<td class="center">296 / 400</td>
									<td class="center">
										4									</td>
									<td class="hidden-xs hidden-sm center">
																				<div class="progress progress-lg progress-squared light" style="margin: 6px;">
											<div class="progress-bar" role="progressbar" aria-valuenow="74.0" aria-valuemin="0" aria-valuemax="100" style="width: 74.0%;">
												74.0 %											</div>
										</div>
									</td>
									<td class="center">
									...
									<td class="center">
										...
										44									</td>
																		<td class="center">
										68									</td>
																		<td class="center">252 / 400</td>
									<td class="center">
										3.375									</td>
									<td class="hidden-xs hidden-sm center">
																				<div class="progress progress-lg progress-squared light" style="margin: 6px;">
											<div class="progress-bar" role="progressbar" aria-valuenow="63.0" aria-valuemin="0" aria-valuemax="100" style="width: 63.0%;">
												63.0 %											</div>
										</div>
									</td>
									<td class="center">
									...
									<td class="center">
										...
										55									</td>
																		<td class="center">
										50									</td>
																		<td class="center">203 / 400</td>
									<td class="center">
										2.5									</td>
									<td class="hidden-xs hidden-sm center">
																				<div class="progress progress-lg progress-squared light" style="margin: 6px;">
											<div class="progress-bar" role="progressbar" aria-valuenow="50.8" aria-valuemin="0" aria-valuemax="100" style="width: 50.8%;">
												50.8 %											</div>
										</div>
									</td>
									<td class="center">
									...
									<td class="center">
										...
										64									</td>
																		<td class="center">
										45									</td>
																		<td class="center">214 / 400</td>
									<td class="center">
										2.5									</td>
									<td class="hidden-xs hidden-sm center">
																				<div class="progress progress-lg progress-squared light" style="margin: 6px;">
											<div class="progress-bar" role="progressbar" aria-valuenow="53.5" aria-valuemin="0" aria-valuemax="100" style="width: 53.5%;">
												53.5 %											</div>
										</div>
									</td>
									<td class="center">
									...
									<td class="center">
										...
										58									</td>
																		<td class="center">
										60									</td>
																		<td class="center">264 / 400</td>
									<td class="center">
										3.625									</td>
									<td class="hidden-xs hidden-sm center">
																				<div class="progress progress-lg progress-squared light" style="margin: 6px;">
											<div class="progress-bar" role="progressbar" aria-valuenow="66.0" aria-valuemin="0" aria-valuemax="100" style="width: 66.0%;">
												66.0 %											</div>
										</div>
									</td>
									<td class="center">
				...
				<footer class="panel-footer">
					<div class="text-right">
						<a href="exam/get_markssheet_print/1/1/1" class="btn btn-primary btn-sm" target="_blank">
