...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			...
			<div class="panel-body">
				<form action="payroll/payslip" id="form" method="post" accept-charset="utf-8">
					<div class="row mb-lg">
						<div class="col-md-6">
							<label class="control-label">
								Employee Type <span class="required">*</span>
							</label>
							<select name="employee_type" class='form-control populate' required data-plugin-selectTwo
...
<option value="12">December</option>
					...
					<center>
						<button type="submit" name="flag" value="1" class="btn btn-primary">
			...
			<header class="panel-heading">
				<h2 class="panel-title"><i class="fa fa-list"></i> Generate Payslip</h2>
			</header>
			<div class="panel-body">
				<table class="table table-bordered table-condensed table-striped mb-none" id = "table_export">
					...
					<tbody>
							...
							<td> 13/May/2018 </td>
							<td>
								<a href="payroll/payslip_details/47" class="btn btn-primary btn-xs" >
							...
							<td> 24/Jul/2018 </td>
							<td>
								<a href="payroll/payslip_details/51" class="btn btn-primary btn-xs" >
									<i class="fa fa-eye"></i> Details								</a>
							</td>
													<tr>
							<td>3</td>
							...
							<td> 15/Sep/2018 </td>
							<td>
								<a href="payroll/payslip_details/56" class="btn btn-primary btn-xs" >
									<i class="fa fa-eye"></i> Details								</a>
							</td>
													<tr>
							<td>4</td>
							<td class='center'><img src="uploads/teacher_image/2.jpg" width="35" height="35"/></td>
							<td> Johanna Luisa </td>
							<td> Teacher </td>
							<td> $ 16000 </td>
							<td> $ 0 </td>
							...
							<td> 09/Oct/2018 </td>
							<td>
								<a href="payroll/payslip_details/59" class="btn btn-primary btn-xs" >
									<i class="fa fa-eye"></i> Details								</a>
							</td>
													<tr>
							<td>5</td>
							...
							<td> 20/Dec/2018 </td>
							<td>
								<a href="payroll/payslip_details/60" class="btn btn-primary btn-xs" >
									<i class="fa fa-eye"></i> Details								</a>
							</td>
													<tr>
							<td>6</td>
							...
							<td> 05/Jan/2019 </td>
							<td>
								<a href="payroll/payslip_details/61" class="btn btn-primary btn-xs" >
									<i class="fa fa-eye"></i> Details								</a>
							</td>
													<tr>
							<td>7</td>
							...
							<td> 19/Jan/2019 </td>
							<td>
								<a href="payroll/payslip_details/62" class="btn btn-primary btn-xs" >
									<i class="fa fa-eye"></i> Details								</a>
							</td>
													</tr>
					</tbody>
