...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Librarian Panel | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			<header class="panel-heading">
				<a class="modal-with-move-anim btn btn-primary btn-xs pull-right" href="#teacher_add"><i class="fa fa-plus-square"></i> Make Librarian</a>
				<h2 class="panel-title"><i class="fa fa-user-circle-o"></i> Librarian List</h2>
			</header>
			<div class="panel-body">
				<table class="table table-bordered table-striped table-condensed mb-none table_default">
					...
					<tbody>
												...
												<tr>
							<td class="center"><img src="uploads/librarian_image/1.jpg" width="35" height="35" /></td>
							<td>Xander Rowe</td>
							<td>02/02/2016</td>
							<td>librarian@rudras.com</td>
							<td>+1-99-2431654</td>
							<td width="120px">
								<input type="checkbox" id="1" data-size="mini" checked name="user_id" >
							</td>
							<td>
								<!-- LIBRARIAN UPDATE LINK -->
								<a href="librarian/profile/1" class="btn btn-xs btn-primary" data-placement="top" data-toggle="tooltip"
								data-original-title="Profile / Edit">
								<i class="el el-user"></i>
								</a>

								<!-- LIBRARIAN DELETION LINK -->
								<a href="#" class="btn btn-xs btn-danger" onclick="confirm_modal('librarian/maintain/delete/1');">
		...
		<!-- MODAL FORM -->
		<div id="teacher_add" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
			<section class="panel panel-featured panel-featured-primary">
				<form action="librarian/maintain/make" id="frm" enctype="multipart/form-data" method="post" accept-charset="utf-8">
					...
					<div class="row">
						<div class="col-md-6 mb-xs">
							<div class="form-group">
								...
								<input type="text" class="form-control" required name="birthday" title="Must Be Required" value=""
								data-plugin-datepicker data-plugin-options='{ "startView": 2 }'>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-4 mb-xs">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="religion" required title="Must Be Required" value="">
							</div>
						</div>
						<div class="col-md-4 mb-xs">
							<div class="form-group">
...
<option value="AB-">AB-</option>
						...
						<div class="col-md-4 mb-xs">
							<div class="form-group">
								...
								required title="Must Be Required" value="">
							</div>
						</div>
					</div>
					...
					<div class="row mb-md">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="email" id="email" required title="Must Be Required" value="">
							</div>
						</div>
		...
		$("form#frm").validate({
			rules: {
				email: {
					email: true,
					remote: {
						url: 'librarian/get_email_exists',
						type: "post",
						data: {
