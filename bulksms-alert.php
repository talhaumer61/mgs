...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Automatic Student Alert Sms | Rudras School</title>
...
<!-- end: sidebar -->
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Automatic Student Alert Sms</h2>
					</header>

					<!-- INCLUDEING PAGE -->
					<div class="tabs tabs-vertical tabs-left tabs-primary">
	<ul class="nav nav-tabs col-sm-2 col-xs-4">
				<li class="active">
			<a href="#tab_1" data-toggle="tab"><i class="fa fa-genderless"></i> Admission</a>
		</li>
				<li class="">
			<a href="#tab_2" data-toggle="tab"><i class="fa fa-genderless"></i> Payments</a>
		</li>
				<li class="">
			<a href="#tab_3" data-toggle="tab"><i class="fa fa-genderless"></i> Attendance</a>
		</li>
				<li class="">
			<a href="#tab_4" data-toggle="tab"><i class="fa fa-genderless"></i> Exam Attendance</a>
		</li>
				<li class="">
			<a href="#tab_5" data-toggle="tab"><i class="fa fa-genderless"></i> Hostel</a>
		</li>
				<li class="">
			<a href="#tab_6" data-toggle="tab"><i class="fa fa-genderless"></i> Transport</a>
		</li>
			</ul>
	<div class="tab-content">
				<div id="tab_1" class="tab-pane active">
			<div class="alert alert-pvs mt-lg">
				<span class="mb-xs mt-xs mr-xs label label-warning">{name}</span>
				<span class="mb-xs mt-xs mr-xs label label-warning">{class}</span>
				<span class="mb-xs mt-xs mr-xs label label-warning">{section}</span>
				<span class="mb-xs mt-xs mr-xs label label-warning">{admission_date}</span>
				<span class="mb-xs mt-xs mr-xs label label-warning">{roll}</span>

				
				
				
			</div>
			<form role="form" action="bulksms/alert/update/1" method="post" class="validate">
				<div class="form-group">
					<label class="control-label">Status</label>
					<select name="status" class='form-control' required data-plugin-selectTwo data-width='100%'
...
<option value="3">Both</option>
				...
				<div class="form-group">
					<textarea name="message" rows="4" class="form-control" placeholder="admission Message" required
					title="Must Be Required" >ok</textarea>
				</div>
				<div class="text-right">
			...
			<div class="alert alert-pvs mt-lg">
				...
				<span class="mb-xs mt-xs mr-xs label label-warning">{roll}</span>
								...
								<span class="mb-xs mt-xs mr-xs label label-warning">{paid_amount}</span>
				<span class="mb-xs mt-xs mr-xs label label-warning">{due_amount}</span>
				<span class="mb-xs mt-xs mr-xs label label-warning">{paid_date}</span>
				
				
				
			</div>
			<form role="form" action="bulksms/alert/update/2" method="post" class="validate">
				<div class="form-group">
					<label class="control-label">Status</label>
					<select name="status" class='form-control' required data-plugin-selectTwo data-width='100%'
					    data-minimum-results-for-search='Infinity' >
...
<option value="3" selected="selected">Both</option>
				...
				<div class="form-group">
					<textarea name="message" rows="4" class="form-control" placeholder="Payments Message" required
					title="Must Be Required" >{name} {class} {section} {admission_date} {roll} {paid_amount} {due_amount} {paid_date}</textarea>
				</div>
				<div class="text-right">
					<button type="submit" class="btn btn-primary">Update</button>
				</div>
			...
			<form role="form" action="bulksms/alert/update/3" method="post" class="validate">
				<div class="form-group">
					<label class="control-label">Status</label>
					<select name="status" class='form-control' required data-plugin-selectTwo data-width='100%'
					    data-minimum-results-for-search='Infinity' >
<option value="no">No</option>
<option value="1">Student</option>
<option value="2" selected="selected">Parents</option>
<option value="3">Both</option>
</select>
				</div>
				<div class="form-group">
					<textarea name="message" rows="4" class="form-control" placeholder="Attendance Message" required
					title="Must Be Required" >asdasdas</textarea>
				</div>
				<div class="text-right">
					<button type="submit" class="btn btn-primary">Update</button>
				</div>
			...
			<form role="form" action="bulksms/alert/update/4" method="post" class="validate">
				<div class="form-group">
					<label class="control-label">Status</label>
					<select name="status" class='form-control' required data-plugin-selectTwo data-width='100%'
					    data-minimum-results-for-search='Infinity' >
...
<option value="3">Both</option>
				...
				<div class="form-group">
					<textarea name="message" rows="4" class="form-control" placeholder="Exam Attendance Message" required
					title="Must Be Required" ></textarea>
				</div>
				<div class="text-right">
					<button type="submit" class="btn btn-primary">Update</button>
				</div>
			...
			<div class="alert alert-pvs mt-lg">
				...
				<span class="mb-xs mt-xs mr-xs label label-warning">{roll}</span>
								...
								<span class="mb-xs mt-xs mr-xs label label-warning">{hostel_name}</span>
				<span class="mb-xs mt-xs mr-xs label label-warning">{room_name}</span>
				
				
			</div>
			<form role="form" action="bulksms/alert/update/5" method="post" class="validate">
				<div class="form-group">
					<label class="control-label">Status</label>
					<select name="status" class='form-control' required data-plugin-selectTwo data-width='100%'
					    data-minimum-results-for-search='Infinity' >
...
<option value="3">Both</option>
				...
				<div class="form-group">
					<textarea name="message" rows="4" class="form-control" placeholder="Hostel Message" required
					title="Must Be Required" ></textarea>
				</div>
				<div class="text-right">
					<button type="submit" class="btn btn-primary">Update</button>
			...
			<div class="alert alert-pvs mt-lg">
				...
				<span class="mb-xs mt-xs mr-xs label label-warning">{roll}</span>
								...
								<span class="mb-xs mt-xs mr-xs label label-warning">{route_name}</span>
				<span class="mb-xs mt-xs mr-xs label label-warning">{vehicle_number}</span>
				<span class="mb-xs mt-xs mr-xs label label-warning">{route_fare}</span>
				<span class="mb-xs mt-xs mr-xs label label-warning">{start_place}</span>
				<span class="mb-xs mt-xs mr-xs label label-warning">{stop_place}</span>
				
			</div>
			<form role="form" action="bulksms/alert/update/6" method="post" class="validate">
				<div class="form-group">
					<label class="control-label">Status</label>
					<select name="status" class='form-control' required data-plugin-selectTwo data-width='100%'
					    data-minimum-results-for-search='Infinity' >
...
<option value="3">Both</option>
				...
				<div class="form-group">
					<textarea name="message" rows="4" class="form-control" placeholder="Transport Message" required
					title="Must Be Required" >gh</textarea>
				</div>
				<div class="text-right">
					<button type="submit" class="btn btn-primary">Update</button>
				</div>
