...
//-----------------------------------------------
	...
	//require_once("include/employee/query_employees_attendce.php");
	include_once("include/header.php");
//-----------------------------------------------
echo '
<title> Attendfance Panel | '.TITLE_HEADER.'</title>
...
//-----------------------------------------------
	...
	include_once("include/employee/attendance_employees_view.php");
//-----------------------------------------------
echo '
</div>
</div>';
