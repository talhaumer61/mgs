...
<!-- end: sidebar -->
				<section role="main" class="content-body">
					...
					<!-- INCLUDEING PAGE -->
					<section class="panel panel-featured panel-featured-primary">
    <form action="attendance/student_report_view" id="form" method="post" accept-charset="utf-8">
	<header class="panel-heading">
	...
	<div class="panel-body">
		<div class="row mb-lg">
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label">Attendance Type <span class="required">*</span></label>
				...
				<div class="form-group">
					...
					<select class="form-control" data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" required title="Must Be Required"
				...
				<div class="form-group">
					<label class="control-label">
						Section					</label>
					<select class="form-control" data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" id ="section_id"
					required title="Must Be Required" name="section_id">
			...
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label">
						Month					</label>
					<select name="month" class="form-control" data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity"
					required title="Must Be Required">
...
<section class="panel panel-featured panel-featured-primary appear-animation mt-sm" data-appear-animation="fadeInRight" data-appear-animation-delay="100">
	<header class="panel-heading">
		...
		Class One ( Section A )   Attendance Report		</h2>
	</header>
	<div class="panel-body">
				...
				<tbody>
						...
						<td style="text-align: center;">
							Cherri Portnoy						</td>
												...
												<td class="center">
														<i class="fa fa-check" style="color: #00a651;"></i>
													</td>
												<td class="center">
													</td>
												<td class="center">
												...
												<td class="center">
														<strong style="color: #46b8da;">H</strong>
													</td>
											<tr>
						<td style="text-align: center;">
							Rudyard Maddox						</td>
	...
	<div class="panel-footer">
		<div class="text-right">
			<a href="attendance/student_report_print/1/1/1/b" class="btn btn-sm btn-primary " target="_blank">
