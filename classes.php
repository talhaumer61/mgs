...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Class Panel | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			<header class="panel-heading">
				<a href="#make_class" class="modal-with-move-anim btn btn-primary btn-xs pull-right">
					<i class="fa fa-plus-square"></i> Make Class				</a>
				<h2 class="panel-title">
					<i class="fa fa-list"></i> Class List				</h2>
			</header>
			<div class="panel-body">
					...
					<tbody>
							...
							<td>
								...
								<div id="edit_1" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
									<section class="panel panel-featured panel-featured-primary">
										<form action="classes/maintain/edit/1" class="form-horizontal validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
										...
										<div class="panel-body">
											<div class="form-group mt-sm">
												...
												<div class="col-md-9">
													<input type="text" class="form-control" name="name" required title="Must Be Required" value="One"/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">Class Numeric <span class="required">*</span></label>
												<div class="col-md-9">
													<input type="number" class="form-control" name="name_numeric" required title="Must Be Required" value="1"/>
												</div>
											</div>
											<div class="form-group mb-md">
												<label class="col-md-3 control-label">Teacher <span class="required">*</span></label>
												<div class="col-md-9">
													<select data-plugin-selectTwo data-minimum-results-for-search="Infinity" data-width="100%" name="teacher_id" required
													title="Must Be Required" class="form-control populate">
														<option value="">Select</option>
																													<option value="1" >Anzo Perez</option>
																													<option value="2" selected>Johanna Luisa</option>
																											</select>
												</div>
											</div>
										</div>
								...
								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('classes/maintain/delete/1');">
		...
		<div id="make_class" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
			<section class="panel panel-featured panel-featured-primary">
				<form action="classes/maintain/make" class="form-horizontal validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-md-3 control-label">Class Numeric <span class="required">*</span></label>
						<div class="col-md-9">
							<input type="number" class="form-control" name="name_numeric" required title="Must Be Required"/>
						</div>
					</div>
					<div class="form-group mb-md">
						<label class="col-md-3 control-label">Teacher <span class="required">*</span></label>
						<div class="col-md-9">
							<select data-plugin-selectTwo data-minimum-results-for-search="Infinity" data-width="100%" name="teacher_id" required title="Must Be Required"
