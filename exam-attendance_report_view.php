...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Student Attendance Report | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			<form action="exam/attendance_report_view" id="form" method="post" accept-charset="utf-8">
			<header class="panel-heading">
			...
			<div class="panel-body">
				...
				<center>
					<button type="submit" class="btn btn-primary"><i class="fa fa-search"></i> Show Report</button>
				</center>
			</div>
			</form>		</section>
			...
			<header class="panel-heading">
				<h2 class="panel-title">
				<i class="fa fa-users"></i>
					SSC Exam Class One ( Section A ) Attendance Report				</h2>
			</header>
			<div class="panel-body">
				<div class="table-responsive mt-sm mb-md">
					<table class="table table-bordered table-striped table-condensed  mb-none" id="my_table">
						...
						<tbody>
								...
								<td> English </td>
																<td>
																			<span class="label label-primary"><i class="fa fa-check"></i> Present</span>
																	</td>
															<tr>
								<td>2</td>
			...
			<div class="panel-footer">
				<div class="text-right">
					<a href="exam/attendance_report_print/1/1/1/1"
