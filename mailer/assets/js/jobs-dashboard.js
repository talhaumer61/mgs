...
var element = document.getElementById("applicantStats");
if (element !== null) {
  element.innerHTML = "";
	var options = {
		chart: {
		...
		colors: ["rgba(142, 84, 233, 1)", "rgba(142, 84, 233, 0.5)", "#4876e6"],
		series: [{
			name: 'Applications',
			type: 'column',
...
// Career Page Stats
var element = document.getElementById("careerPageStats");
if (element !== null) {
  element.innerHTML = "";
	var options = {
		series: [ {
			name: 'Accepted',
			type: 'line',
			data: [10, 25, 6, 28, 10, 25, 5]
		},
		{
			name: 'Rejected',
			type: 'area',
			data: [20, 5, 36, 15, 28, 15, 35]
		}],
		chart: {
		height: 230,
		...
		colors: ["rgba(142, 84, 233, 0.99)","rgba(142, 84, 233, 0.08)"],
	};
