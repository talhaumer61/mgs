...
// Statistics Chart
var element = document.getElementById("marketCap");
if (element !== null) {
  element.innerHTML = "";
  var options = {
    series: [{
  ...
  var chart1 = new ApexCharts(document.querySelector("#marketCap"), options);
  chart1.render();
}
function marketCap(){
...
// Prediction Meter Chart
var element = document.getElementById("trademeter");
if (element !== null) {
  element.innerHTML = "";
  var options = {
    series: [73],
  ...
  var chart = new ApexCharts(document.querySelector("#trademeter"), options);
  chart.render();
}
