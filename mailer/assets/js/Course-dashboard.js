...
var element = document.getElementById("CourseStatistics");
if (element !== null) {
    element.innerHTML = "";
    var options = {
        series: [{
        ...
        colors: ["rgba(142, 84, 233, 0.99)", '#4876e6'],
    };
...
var element = document.getElementById("payoutsReport");
if (element !== null) {
    element.innerHTML = "";
    var options2 = {
        series: [{
        ...
        colors: ["rgba(142, 84, 233, 0.07)", "#ffb8a5"],
    };
