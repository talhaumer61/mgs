// for NFTs Statistics
var element = document.getElementById("projectstatistics");
if (element !== null) {
  element.innerHTML = "";
  var options = {
    series: [{
    ...
    colors: ["rgba(142, 84, 233, 0.95)", ,"#4876e6"]
  };
...
if (element !== null) {
  ...
  var options = {
    ...
    colors: ["rgba(142, 84, 233, 0.95)",   '#e791bc', '#f68466', '#f5b849'],
  };
...
if (typeof jsVectorMap !== 'undefined') {
  ...
  var element = document.getElementById("country-sales");
  if (element !== null) {
    element.innerHTML = "";
