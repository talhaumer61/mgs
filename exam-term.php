...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Term Panel | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-5">
		<section class="panel panel-featured panel-featured-primary">
			<header class="panel-heading">
				<h2 class="panel-title">Add Term</h2>
			</header>
			<div class="panel-body">
				<form role="form" action="exam/term/make" method="post" class="validate">
					<div class="form-group ">
						<label class="control-label">
							Name <span class="required">*</span>
						</label>
						<input type="text" class="form-control" name="termname" required title="Must Be Required" value="" autofocus />
											</div>
				...
				<div class="table-responsive">
					<table class="table table-bordered table-striped table-condensed mb-none">
						...
						<tbody>
								...
								<td> First </td>
								<td>
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#term1"><i class="glyphicon glyphicon-edit"></i> Edit</a>
									<!-- TERM UPDATE MODAL FORM -->
									<div id="term1" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<div class="row">
											<div class="col-md-12">
												<section class="panel panel-featured panel-featured-primary">
													<form role="form" action="exam/term/edit/1" method="post" class="validate">
														<header class="panel-heading">
														...
														<div class="panel-body">
															<div class="form-group mb-sm">
																...
																<input type="text" class="form-control" required title="Must Be Required" value="First" name="termname">
									...
									<!-- TERM DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('exam/term/delete/1');"> <i class="fa fa-trash"></i>
									</a>
								</td>
							</tr>
														<tr>
								<td> Second </td>
								<td>
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#term2"><i class="glyphicon glyphicon-edit"></i> Edit</a>
									<!-- TERM UPDATE MODAL FORM -->
									<div id="term2" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<div class="row">
											<div class="col-md-12">
												<section class="panel panel-featured panel-featured-primary">
													<form role="form" action="exam/term/edit/2" method="post" class="validate">
														<header class="panel-heading">
															<h2 class="panel-title">
																<i class="glyphicon glyphicon-edit"></i> Edit															</h2>
														</header>
														...
														<div class="panel-body">
															<div class="form-group mb-sm">
																...
																<input type="text" class="form-control" required title="Must Be Required" value="Second" name="termname">
									...
									<!-- TERM DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('exam/term/delete/2');"> <i class="fa fa-trash"></i>
									</a>
								</td>
							</tr>
													</tbody>
