...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Subject Panel | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="panel-body">
		<div class="row mb-sm">
			<div class="form-group">
				<center>
					<label class="col-sm-6 col-sm-offset-3 control-label" style="margin-bottom: 5px;">
						Class					</label>
				</center>
	...
	<div class="panel-body">
		<table class="table table-bordered table-striped mb-none table_default">
			...
			<tbody>
					...
					<td>
						<!-- SUBJECT UPDATE LINK -->
						<a href="#edit_1" class="modal-with-move-anim-pvs btn btn-primary btn-xs">
...
<div id="edit_1" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
	<div class="row">
		<div class="col-md-12">
			<section class="panel panel-featured panel-featured-primary">
				<form action="subject/maintain/edit/1" class="form-horizontal mb-lg" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
						<select name="subject_type" class='form-control populate' data-plugin-selectTwo data-width='100%'
...
<option value="Mandatory">Mandatory</option>
				...
				<footer class="panel-footer">
					<div class="text-right">
						...
						<!-- DELETION LINK -->
						<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('subject/maintain/delete/1/1');">
					...
					<td>
						<!-- SUBJECT UPDATE LINK -->
						<a href="#edit_2" class="modal-with-move-anim-pvs btn btn-primary btn-xs">
						  <i class="glyphicon glyphicon-edit"></i> Edit						</a>
...
<div id="edit_2" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
	<div class="row">
		<div class="col-md-12">
			<section class="panel panel-featured panel-featured-primary">
				<form action="subject/maintain/edit/2" class="form-horizontal mb-lg" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				...
				<div class="panel-body">
					<div class="form-group mt-sm">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" name="name" required value="Bangla"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" name="subject_code" required value="102"/>
						</div>
					</div>
...
<option value="Mandatory">Mandatory</option>
				...
				<footer class="panel-footer">
					<div class="text-right">
						...
						<!-- DELETION LINK -->
						<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('subject/maintain/delete/2/1');">
						  <i class="el el-trash"></i>
						</a>
...
<div id="edit_3" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
	<div class="row">
		<div class="col-md-12">
			<section class="panel panel-featured panel-featured-primary">
				<form action="subject/maintain/edit/3" class="form-horizontal mb-lg" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				...
				<div class="panel-body">
					<div class="form-group mt-sm">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" name="name" required value="Computer"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" name="subject_code" required value="103"/>
						</div>
					</div>
...
<option value="Mandatory">Mandatory</option>
				...
				<footer class="panel-footer">
					<div class="text-right">
						...
						<!-- DELETION LINK -->
						<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('subject/maintain/delete/3/1');">
						  <i class="el el-trash"></i>
						</a>
...
<div id="edit_4" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
	<div class="row">
		<div class="col-md-12">
			<section class="panel panel-featured panel-featured-primary">
				<form action="subject/maintain/edit/4" class="form-horizontal mb-lg" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				...
				<div class="panel-body">
					<div class="form-group mt-sm">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" name="name" required value="Mathematics"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" name="subject_code" required value="104"/>
						</div>
					</div>
...
<option value="Mandatory">Mandatory</option>
				...
				<footer class="panel-footer">
					<div class="text-right">
						...
						<!-- DELETION LINK -->
						<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('subject/maintain/delete/4/1');">
						  <i class="el el-trash"></i>
						</a>
...
<div id="make_subject" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
	<div class="row">
		<div class="col-md-12">
			<section class="panel panel-featured panel-featured-primary">
				<form action="subject/maintain/create/" class="form-horizontal mb-lg" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
...
<script type="text/javascript">
    function class_section() {
    	...
    	if (class_id == 0) {
    		...
    		window.location.href = 'subject/view/' + class_id;
    	}
    }
</script>				</section>
			</div>
