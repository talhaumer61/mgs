...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Fee Invoice | Rudras School</title>
			...
			<header class="clearfix">
				<div class="row">
					<div class="col-sm-6 mt-md">
						...
						<h4 class="h4 m-none text-dark text-weight-bold">#317</h4>
					</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="bill-to">
							...
							<address>
								...
								Roll : 101<br>
								Class : One<br>
								Email : student@rudras.com							</address>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="bill-data text-right">
							...
							<p class="mb-none">
								<span class="text-dark">Fee Category : </span>
								<span>Academic Fees</span>
							</p>
							
							<p class="mb-none">
								<span class="text-dark">Status : </span>
								<span class='label label-info '>Partly Paid</span>							</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="table-responsive">
				<table class="table invoice-items">
					...
					<tbody>
												<tr>
							<td>1</td>
							<td class="text-weight-semibold text-dark">07/Jan/2019</td>
							<td></td>
