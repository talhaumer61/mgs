...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Library Panel | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			<header class="panel-heading">
				<a href="#addbook" class="btn btn-primary btn-xs modal-with-move-anim pull-right">
				...
				<table class="table table-bordered table-striped table-condensed mb-none table_default">
					...
					<tbody>
							...
							<td>
								...
								<!-- UPDATE LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/library/modal_books_update.php?id=1');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('library/maintain/delete/1');">
							...
							<td>
								...
								<!-- UPDATE LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/library/modal_books_update.php?id=2');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('library/maintain/delete/2');">
								<i class="el el-trash"></i>
								</a>
							...
							<td>
								...
								<!-- UPDATE LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/library/modal_books_update.php?id=3');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('library/maintain/delete/3');">
								<i class="el el-trash"></i>
								</a>
							...
							<td>
								...
								<!-- UPDATE LINK -->
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom('ajax/modal/library/modal_books_update.php?id=4');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('library/maintain/delete/4');">
								<i class="el el-trash"></i>
								</a>
		...
		<!-- ADD BOOK MODAL DIALOGBOX -->
		<div id="addbook" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
			<section class="panel panel-featured panel-featured-primary">
			<form action="library/maintain/create" class="form-horizontal" id="form" method="post" accept-charset="utf-8">
				<header class="panel-heading">
					<h2 class="panel-title"><i class="fa fa-plus-square"></i> Add Book</h2>
				</header>
				<div class="panel-body">
					<div class="modal-wrapper">
						<div class="form-group">
							<label class="col-sm-3 control-label">Name <span class="required">*</span></label>
							<div class="col-sm-9"><input type="text" class="form-control" name="name" required title="Must Be Required"/></div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">Author</label>
							<div class="col-sm-9"><input type="text" class="form-control" name="author"/></div>
						</div>

						<div class="form-group">
							<label class="col-sm-3 control-label">Book ISBN No</label>
							<div class="col-sm-9"><input type="text" class="form-control" name="isbn_no"/></div>
						</div>

						<div class="form-group">
							<label class="col-sm-3 control-label">Book Category <span class="required">*</span></label>
							<div class="col-sm-9">
								<select data-plugin-selectTwo data-plugin-selectTwo data-width="100%" name="book_category" required title="Must Be Required" class="form-control populate">
						...
						<div class="form-group">
							...
							<div class="col-sm-9"><input type="text" class="form-control" required title="Must Be Required" name="publisher"/></div>
						</div>

						<div class="form-group">
							<label class="col-sm-3 control-label">Description</label>
							<div class="col-sm-9"><input type="text" class="form-control" name="description"/></div>
						</div>

						<div class="form-group">
							<label class="col-sm-3 control-label">Price <span class="required">*</span></label>
							<div class="col-sm-9"><input type="number" class="form-control" required title="Must Be Required" name="price"/></div>
						</div>
							...
							<div class="col-sm-9">
								<div data-plugin-spinner data-plugin-options='{ "value":0, "min": 0 }'>
									<div class="input-group">
										<input type="text" class="spinner-input form-control" required name="total_stock" value="0" title="Must Be Required" maxlength="3">
