			...
			<header class="clearfix">
				<div class="row">
					<div class="col-sm-6 mt-md">
						...
						<h4 class="h4 m-none text-dark text-weight-bold">#63fdb3db</h4>
					</div>
					<div class="col-sm-6 text-right mt-md mb-md">
						<address class="ib mr-xlg">
							Rudras School Management System ERP<br/>
							New York, United States<br/>
							+15452312224<br/> 
							admin@shivas.com   
						</address>
						<div class="ib">
							<img src="assets/images/invoice-logo.png" alt="Shivas School" />
						</div>
					</div>
				</div>
			</header>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="bill-to">
							...
							<address>
								Anzo Perez<br>
								Employee Type : Teacher<br>
								Joining Date : 08/12/2016								<br>
								Email : teacher@rudras.com							</address>
						</div>
					</div>
							...
							<div class="table-responsive">
								<table class="table invoice-items">
									...
									<tbody>
																				<tr>
											<td>1</td>
											<td class="text-weight-semibold text-dark">Medical</td>
											<td>1000</td>
										</tr>
																				<tr>
											<td>2</td>
											<td class="text-weight-semibold text-dark">House Rent</td>
											<td>300</td>
										</tr>
																			</tbody>
								</table>
							...
							<div class="table-responsive">
								<table class="table invoice-items">
									...
									<tbody>
																				<tr>
											<td>1</td>
											<td class="text-weight-semibold text-dark">Loan</td>
											<td>1500</td>
										</tr>
																				<tr>
											<td>2</td>
											<td class="text-weight-semibold text-dark">Advance Salary</td>
											<td>5000</td>
										</tr>
																			</tbody>
								</table>
						...
						<table class="table h5 text-dark">
							<tbody>
								...
								<tr>
									...
									<td class="text-left">$ 1300</td>
								</tr>
								<tr>
									<td colspan="2">Total Deductions</td>
									<td class="text-left">$ 6500</td>
								</tr>
								<tr class="h4">
									<td colspan="2">Net Salary</td>
									<td class="text-left">$ 10800</td>
								</tr>
							</tbody>
						</table>
					</div>
