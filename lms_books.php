...
require_once("include/books/query_lms_books.php");
...
if(($_SESSION['userlogininfo']['LOGINAFOR'] == 1 && $_SESSION['userlogininfo']['LOGINTYPE'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE'] == '1' && in_array('40', $_SESSION['userlogininfo']['PERMISSIONS'])) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '40', 'view' => '1'))) {
	echo '
	<title> Books Panel | '.TITLE_HEADER.'</title>
	<section role="main" class="content-body">
		...
		<div class="row">
			<div class="col-md-12">';
				include_once("include/books/list_lms_books.php");
				include_once("include/modals/books/modal_lms_books_add.php");
				echo'
			</div>
		</div>
	</section>';
