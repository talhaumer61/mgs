...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Leave Control Panel | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-5">
		<section class="panel panel-featured panel-featured-primary">
			<header class="panel-heading">
				<h2 class="panel-title">Add Leave Category</h2>
			</header>
			<div class="panel-body">
				<form role="form" action="leave/category/make" method="post" class="validate">
					<div class="form-group ">
						<label class="control-label">
							Name <span class="required">*</span>
						</label>
						<input type="text" class="form-control" name="leave_category" required title="Must Be Required" value="" autofocus />
											</div>
					...
					<div class="form-group">
						...
						<input type="number" class="form-control" name="leave_days" required title="Must Be Required" 
						value="" placeholder="Fixed Days" />
					</div>
	...
	<div class="col-md-7">
		<section class="panel panel-featured panel-featured-primary">
			<header class="panel-heading">
				<h2 class="panel-title"><i class="fa fa-list"></i> Leave Category List</h2>
			</header>
			<div class="panel-body">
								...
								<td>
									...
									<div id="edit_11" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<div class="row">
											<div class="col-md-12">
												<section class="panel panel-featured panel-featured-primary">
													<form role="form" action="leave/category/update/11" method="post" class="validate">
														<header class="panel-heading">
														...
														<div class="panel-body">
															<div class="form-group mb-sm">
																...
																<input type="text" class="form-control" required title="Must Be Required" value="Sample 1" name="leave_category">
															</div>
															<div class="form-group">
																<label class="control-label">
																	Days <span class="required">*</span>
																</label>
																<input type="text" class="form-control" name="leave_days" required title="Must Be Required" 
																value="10" placeholder="Days Limit" />
															</div>
														</div>
									...
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('leave/category/delete/11');">
								...
								<td>
									...
									<div id="edit_12" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<div class="row">
											<div class="col-md-12">
												<section class="panel panel-featured panel-featured-primary">
													<form role="form" action="leave/category/update/12" method="post" class="validate">
														<header class="panel-heading">
															<h2 class="panel-title">
																<i class="glyphicon glyphicon-edit"></i> Edit															</h2>
														</header>
														...
														<div class="panel-body">
															<div class="form-group mb-sm">
																...
																<input type="text" class="form-control" required title="Must Be Required" value="Sample 2" name="leave_category">
															</div>
															<div class="form-group">
																<label class="control-label">
																	Days <span class="required">*</span>
																...
																<input type="text" class="form-control" name="leave_days" required title="Must Be Required" 
																value="15" placeholder="Days Limit" />
															</div>
														</div>
									...
									<!-- COSTING CATEGORY DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('leave/category/delete/12');">
									<i class="el el-trash"></i>
									</a>
								...
								<td>
									...
									<div id="edit_13" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<div class="row">
											<div class="col-md-12">
												<section class="panel panel-featured panel-featured-primary">
													<form role="form" action="leave/category/update/13" method="post" class="validate">
														<header class="panel-heading">
															<h2 class="panel-title">
																<i class="glyphicon glyphicon-edit"></i> Edit															</h2>
														</header>
														...
														<div class="panel-body">
															<div class="form-group mb-sm">
																...
																<input type="text" class="form-control" required title="Must Be Required" value="Sample 3" name="leave_category">
															</div>
															<div class="form-group">
																<label class="control-label">
																	Days <span class="required">*</span>
																...
																<input type="text" class="form-control" name="leave_days" required title="Must Be Required" 
																value="20" placeholder="Days Limit" />
															</div>
														</div>
									...
									<!-- COSTING CATEGORY DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('leave/category/delete/13');">
									<i class="el el-trash"></i>
									</a>
