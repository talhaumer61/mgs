...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Exam Attendance Marking | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
		<form action="exam/attendance" id="form" method="post" accept-charset="utf-8">
			<header class="panel-heading">
			...
			<div class="panel-body">
				<div class="row mb-sm">
					<div class="col-md-3 mb-sm">
						...
						<label class="control-label">Exam <span class="required">*</span></label>
							<select name="exam_id" class="form-control" data-plugin-selectTwo required title="Must Be Required" data-width="100%" data-minimum-results-for-search="Infinity">
							<option value="">Select</option>
																<option value="1" selected > SSC </option>
																<option value="2"  > HSC </option>
																<option value="3"  > School ( First ) </option>
															</select>
						</div>
					</div>
					...
					<div class="col-md-3 mb-sm">
						...
						<label class="control-label">Class <span class="required">*</span></label>
							<select name="class_id" data-plugin-selectTwo data-minimum-results-for-search="Infinity" data-width="100%" required title="Must Be Required"
							class="form-control populate" onchange="return get_class_section_subject(this.value)">
					...
					<div class="col-md-3 mb-sm">
						...
						<label class="control-label">Section <span class="required">*</span></label>
							<select name="section_id" data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" required title="Must Be Required"
							id="section_holder" class="form-control populate">
					...
					<div class="col-md-3">
						...
						<label class="control-label">Subject <span class="required">*</span></label>
							<select name="subject_id" data-plugin-selectTwo data-width="100%" id="subject_holder" data-minimum-results-for-search="Infinity" required
				...
				<center>
					<button type="submit" class="btn btn-primary"><i class="fa fa-check-square-o"></i> Marking Attendance</button>
				</center>
			</div>
			</form>		</section>
			...
			<form action="exam/attendance_update/1/1/1/1" method="post" accept-charset="utf-8">
				<header class="panel-heading">
					<h2 class="panel-title">
					    <i class="fa fa-users"></i> <span class="hidden-xs">Class One ( Section A ) </span> Students List					</h2>
				</header>
				<div class="panel-body">
				<div class="text-right mb-md">
					...
					<div class="table-responsive mb-sm">
						<table class="table table-bordered">
							...
							<tbody>
																<tr>
									<td>1</td>
									<td class="center"><img src="uploads/student_image/1.jpg" width="35" height="35" /></td>
									<td>
										Cherri Portnoy									</td>
									<td>101</td>
									...
									<td>
										<div class="radio-custom radio-success radio-inline">
											<input type="radio" value="p" checked name="status_1" id="pstatus_0">
											<label for="pstatus_0">Present</label>
										</div>

										<div class="radio-custom radio-danger radio-inline">
											<input type="radio" value="a"  name="status_1" id="astatus_0">
											<label for="astatus_0">Absent</label>
										</div>

										<div class="radio-custom radio-inline">
											<input type="radio" value="l"  name="status_1" id="lstatus_0">
											<label for="lstatus_0">Late</label>
										</div>
									</td>
								</tr>
																<tr>
									<td>2</td>
									<td class="center"><img src="uploads/student_image/2.jpg" width="35" height="35" /></td>
									<td>
										Rudyard Maddox									</td>
									<td>102</td>
									...
									<td>
										<div class="radio-custom radio-success radio-inline">
											<input type="radio" value="p" checked name="status_2" id="pstatus_1">
											<label for="pstatus_1">Present</label>
										</div>

										<div class="radio-custom radio-danger radio-inline">
											<input type="radio" value="a"  name="status_2" id="astatus_1">
											<label for="astatus_1">Absent</label>
										</div>

										<div class="radio-custom radio-inline">
											<input type="radio" value="l"  name="status_2" id="lstatus_1">
											<label for="lstatus_1">Late</label>
										</div>
									</td>
								</tr>
																<tr>
									<td>3</td>
									<td class="center"><img src="uploads/student_image/3.jpg" width="35" height="35" /></td>
									<td>
										Sweet Mondal									</td>
									<td>103</td>
									...
									<td>
										<div class="radio-custom radio-success radio-inline">
											<input type="radio" value="p" checked name="status_3" id="pstatus_2">
											<label for="pstatus_2">Present</label>
										</div>

										<div class="radio-custom radio-danger radio-inline">
											<input type="radio" value="a"  name="status_3" id="astatus_2">
											<label for="astatus_2">Absent</label>
										</div>

										<div class="radio-custom radio-inline">
											<input type="radio" value="l"  name="status_3" id="lstatus_2">
											<label for="lstatus_2">Late</label>
										</div>
									</td>
								</tr>
																<tr>
									<td>4</td>
									<td class="center"><img src="uploads/student_image/4.jpg" width="35" height="35" /></td>
									<td>
										Blake Estes									</td>
									<td>104</td>
									...
									<td>
										<div class="radio-custom radio-success radio-inline">
											<input type="radio" value="p" checked name="status_4" id="pstatus_3">
											<label for="pstatus_3">Present</label>
										</div>

										<div class="radio-custom radio-danger radio-inline">
											<input type="radio" value="a"  name="status_4" id="astatus_3">
											<label for="astatus_3">Absent</label>
										</div>

										<div class="radio-custom radio-inline">
											<input type="radio" value="l"  name="status_4" id="lstatus_3">
											<label for="lstatus_3">Late</label>
										</div>
									</td>
								</tr>
																<tr>
									<td>5</td>
									<td class="center"><img src="uploads/student_image/5.jpg" width="35" height="35" /></td>
									<td>
										Carter Bradford									</td>
									<td>105</td>
									...
									<td>
										<div class="radio-custom radio-success radio-inline">
											<input type="radio" value="p" checked name="status_5" id="pstatus_4">
											<label for="pstatus_4">Present</label>
										</div>

										<div class="radio-custom radio-danger radio-inline">
											<input type="radio" value="a"  name="status_5" id="astatus_4">
											<label for="astatus_4">Absent</label>
										</div>

										<div class="radio-custom radio-inline">
											<input type="radio" value="l"  name="status_5" id="lstatus_4">
											<label for="lstatus_4">Late</label>
										</div>
									</td>
								</tr>
															</tbody>
...
<script type="text/javascript">
	function get_class_section_subject( class_id ) {
		$.ajax( {
			url: 'exam/get_class_section/' + class_id,
		...
		$.ajax( {
			url: 'exam/get_class_subject/' + class_id,
			success: function ( response ) {
