...
require_once("include/books/query_book.php");
...
if(($_SESSION['userlogininfo']['LOGINAFOR'] == 1 && $_SESSION['userlogininfo']['LOGINTYPE'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE'] == '1' && in_array('39', $_SESSION['userlogininfo']['PERMISSIONS'])) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '39', 'view' => '1'))) {
	echo '
	<title> Book category panel | '.TITLE_HEADER.'</title>
	<section role="main" class="content-body">
		<header class="page-header">
			<h2> Bookcategory Panel </h2>
		</header>
		<div class="row">
			<div class="col-md-12">';
				include_once("include/books/list.php");
				include_once("include/modals/books/add.php");
				echo'
			</div>
		</div>
	</section>';
