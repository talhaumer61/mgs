...
<tr>
	...
	<td>
	<!-- SUBJECT UPDATE LINK -->
		<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom(\'include/academic/subjects/modal/modal_subject_update.php?id=1\');"><i class="glyphicon glyphicon-edit"></i> Edit</a>
	<!-- DELETION LINK -->
...
<tr>
	...
	<td>
	<!-- SUBJECT UPDATE LINK -->
		<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom(\'modal/popup/modal_books_update/1\');"><i class="glyphicon glyphicon-edit"></i> Edit</a>
	<!-- DELETION LINK -->
		<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal(\'subject/maintain/delete/1/1\');"><i class="el el-trash"></i></a>
	</td>
</tr>
