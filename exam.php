...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Exam Panel | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			<header class="panel-heading">
				<a href="#make_exam" class="modal-with-move-anim btn btn-primary btn-xs pull-right">
					<i class="fa fa-plus-square"></i> Make Exam				</a>
			...
			<div class="panel-body">
				<table class="table table-bordered table-striped mb-none table_default">
					...
					<tbody>
							...
							<td>
								<!-- UPDATR LINK -->								
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-xs btn-primary" onclick="showAjaxModalZoom('ajax/modal/exam/modal_exam_update.php?id=1');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-xs btn-danger" onclick="confirm_modal('exam/maintain/delete/1');">
							...
							<td>
								<!-- UPDATR LINK -->								
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-xs btn-primary" onclick="showAjaxModalZoom('ajax/modal/exam/modal_exam_update.php?id=2');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-xs btn-danger" onclick="confirm_modal('exam/maintain/delete/2');">
								<i class="el el-trash"></i>
								</a>
							</td>
						</tr>
							...
							<td>
								<!-- UPDATR LINK -->								
								<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-xs btn-primary" onclick="showAjaxModalZoom('ajax/modal/exam/modal_exam_update.php?id=3');">
								<i class="glyphicon glyphicon-edit"></i> Edit								</a>

								<!-- DELETION LINK -->
								<a href="#" class="btn btn-xs btn-danger" onclick="confirm_modal('exam/maintain/delete/3');">
								<i class="el el-trash"></i>
								</a>
							</td>
						</tr>
		...
		<!-- Add Modal Box -->
		<div id="make_exam" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
			<div class="row">
				<div class="col-md-12">
					<section class="panel panel-featured panel-featured-primary">
						<form action="exam/maintain/make" class="form-horizontal" id="form" method="post" accept-charset="utf-8">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<div class="input-daterange input-group" data-plugin-datepicker>
										...
										<input type="text" class="form-control" name="start_date" required title="Must Be Required" value="01/19/2019">
										<span class="input-group-addon">to</span>
										<input type="text" class="form-control" name="end_date" required title="Must Be Required" value="01/19/2019">
									</div>
								</div>
							</div>
