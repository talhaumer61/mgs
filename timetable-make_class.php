...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			<form action="timetable/maintain/create" id="form" method="post" accept-charset="utf-8">
			<header class="panel-heading">
				...
				<div class="row">
					<div class="col-md-6 mt-sm">
						<div class="form-group">
							...
							<select name="section_id" data-plugin-selectTwo data-width="100%" required title="Must Be Required"
					...
					<div class="col-md-6 mt-sm">
						<div class="form-group">
							...
							<select name="subject_id" data-plugin-selectTwo data-width="100%" id="subject_holder" required 
					...
					<div class="col-md-4 mt-sm">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" name="time_start" required title="Must Be Required" data-plugin-timepicker class="form-control"
					...
					<div class="col-md-4 mt-sm">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" name="time_end" required title="Must Be Required" data-plugin-timepicker class="form-control"
								data-plugin-options='{ "minuteStep": 5 }'>
							</div>
						</div>
					</div>
