...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Daily Class Routine | Rudras School</title>
...
<!-- end: sidebar -->
			...
			<div class="row mb-lg">
				<div class="col-md-6">
					<div class="form-group">
						...
						title="Must Be Required" id="class_id" onchange="select_section(this.value)">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						title="Must Be Required" required id="section_holder">
	...
	<section class="panel panel-featured panel-featured-primary appear-animation mt-sm" data-appear-animation="fadeInRight" data-appear-animation-delay="100">
		<header class="panel-heading">
			<a href="timetable/documents_print/1/1" class="btn btn-primary btn-xs pull-right" target="_blank">
			    <i class="glyphicon glyphicon-print"></i> Print			</a>
			<h2 class="panel-title">
			    <i class="fa fa-clock-o"></i> Class One ( Section A ) Daily Class Routine			</h2>
		</header>
		<div class="panel-body">
				...
				<tbody>
						...
						<td>
								...
								<button class="mb-xs mt-xs mr-xs btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown">
									Computer									(1:25 AM - 2:25 AM)									<br>Teacher : Anzo Perez									<br>Class Room : #1									<span class="caret"></span>
								</button>
									...
									<li>
										<a href="#" onclick="confirm_modal('timetable/maintain/delete/4');">
											<i class="el el-trash"></i> Delete										</a>
														...
														<div class="btn-group">
								<button class="mb-xs mt-xs mr-xs btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown">
									Mathematics									(11:25 PM - 9:25 PM)									<br>Teacher : Anzo Perez									<br>Class Room : #2									<span class="caret"></span>
								</button>
								<ul class="dropdown-menu">
									<li>
										<a href="timetable/class_update/3">
											<i class="glyphicon glyphicon-edit"></i>
											Edit										</a>
									</li>
									<li>
										<a href="#" onclick="confirm_modal('timetable/maintain/delete/3');">
											<i class="el el-trash"></i> Delete										</a>
									</li>
								</ul>
							</div>
														<div class="btn-group">
								<button class="mb-xs mt-xs mr-xs btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown">
									Bangla									(2:25 PM - 3:25 PM)									<br>Teacher : Anzo Perez									<br>Class Room : #8									<span class="caret"></span>
								</button>
								<ul class="dropdown-menu">
									<li>
										<a href="timetable/class_update/5">
											<i class="glyphicon glyphicon-edit"></i>
											Edit										</a>
									</li>
									<li>
										<a href="#" onclick="confirm_modal('timetable/maintain/delete/5');">
											<i class="el el-trash"></i> Delete										</a>
									</li>
								</ul>
							</div>
														<div class="btn-group">
								<button class="mb-xs mt-xs mr-xs btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown">
									English									(8:30 PM - 9:30 PM)									<br>Teacher : Anzo Perez									<br>Class Room : #1									<span class="caret"></span>
								</button>
								<ul class="dropdown-menu">
									<li>
										<a href="timetable/class_update/1">
											<i class="glyphicon glyphicon-edit"></i>
											Edit										</a>
									</li>
									<li>
										<a href="#" onclick="confirm_modal('timetable/maintain/delete/1');">
											<i class="el el-trash"></i> Delete										</a>
									</li>
								</ul>
							</div>
						...
						<td>
														<div class="btn-group">
								<button class="mb-xs mt-xs mr-xs btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown">
									Bangla									(11:30 AM - 12:30 PM)									<br>Teacher : Anzo Perez									<br>Class Room : #2									<span class="caret"></span>
								</button>
								<ul class="dropdown-menu">
									<li>
										<a href="timetable/class_update/2">
											<i class="glyphicon glyphicon-edit"></i>
											Edit										</a>
									</li>
									<li>
										<a href="#" onclick="confirm_modal('timetable/maintain/delete/2');">
											<i class="el el-trash"></i> Delete										</a>
									</li>
								</ul>
							</div>
														<div class="btn-group">
								<button class="mb-xs mt-xs mr-xs btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown">
									English									(12:30 PM - 1:30 PM)									<br>Teacher : Anzo Perez									<br>Class Room : #3									<span class="caret"></span>
								</button>
								<ul class="dropdown-menu">
									<li>
										<a href="timetable/class_update/6">
											<i class="glyphicon glyphicon-edit"></i>
											Edit										</a>
									</li>
									<li>
										<a href="#" onclick="confirm_modal('timetable/maintain/delete/6');">
											<i class="el el-trash"></i> Delete										</a>
									</li>
								</ul>
							</div>
...
<script type="text/javascript">
	...
	$( "#form" ).submit( function ( event ) {
		...
		var section_id = document.getElementById( "section_holder" ).value;
		if ( class_id != 0 && section_id != 0 ) {
			window.location.href = 'timetable/class_view/' + class_id + '/' + section_id;
		}
