...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Fee Category | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-5">
		<section class="panel panel-featured panel-featured-primary">
			<header class="panel-heading">
				<h2 class="panel-title"><i class="fa fa-money"></i> Fee Category</h2>
			</header>
			<form role="form" action="accounting/fee_category/create" method="post" class="validate">
				<div class="panel-body">
					<div class="form-group ">
						<label class="control-label">
							Fee Category Name <span class="required">*</span>
						</label>
						<input type="text" class="form-control" name="fee_category_name" required title="Must Be Required" value="" autofocus>
											</div>
				...
				<div class="panel-footer">
					<div class="row">
						<div class="col-md-12">
							<button class="btn btn-primary pull-right" type="submit"><i class="fa fa-plus-circle"></i> Save</button>
						</div>	
					</div>
				</div>
			</form>
	...
	<div class="col-md-7">
		<section class="panel panel-featured panel-featured-primary">
			<header class="panel-heading">
				<h2 class="panel-title"><i class="fa fa-list"></i> Fees List</h2>
			</header>
				...
				<div class="table-responsive">
					<table class="table table-bordered table-striped table-condensed mb-none">
						...
						<tbody>
								...
								<td>
									<!-- FEES UPDATE  LINK -->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#fee_category1">
									<i class="glyphicon glyphicon-edit"></i> Edit</a>
									<!-- EDIT MODAL FORM -->
									<div id="fee_category1" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<section class="panel panel-featured panel-featured-primary">
											<form role="form" action="accounting/fee_category/edit/1" method="post" class="validate">
												<header class="panel-heading">
												...
												<div class="panel-body">
													<div class="form-group mb-sm">
														...
														<input type="text" class="form-control" required title="Must Be Required" 
														value="Academic Fees" name="fee_category_name">
													</div>
													...
													<div class="form-group">
														...
														<input type="number" class="form-control" required name="amount" value="5000"/>
													</div>
									...
									<!-- FEES DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/fee_category/delete/1');">
								...
								<td>
									<!-- FEES UPDATE  LINK -->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#fee_category2">
									<i class="glyphicon glyphicon-edit"></i> Edit</a>
									<!-- EDIT MODAL FORM -->
									<div id="fee_category2" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<section class="panel panel-featured panel-featured-primary">
											<form role="form" action="accounting/fee_category/edit/2" method="post" class="validate">
												<header class="panel-heading">
													<h2 class="panel-title">
														<i class="glyphicon glyphicon-edit"></i> Edit													</h2>
												</header>
												...
												<div class="panel-body">
													<div class="form-group mb-sm">
														...
														<input type="text" class="form-control" required title="Must Be Required" 
														value="Sports Fee" name="fee_category_name">
													</div>
													...
													<div class="form-group">
														...
														<input type="number" class="form-control" required name="amount" value="100"/>
													</div>
									...
									<!-- FEES DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/fee_category/delete/2');">
									<i class="el el-trash"></i>
									</a>
								...
								<td>
									<!-- FEES UPDATE  LINK -->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#fee_category3">
									<i class="glyphicon glyphicon-edit"></i> Edit</a>
									<!-- EDIT MODAL FORM -->
									<div id="fee_category3" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<section class="panel panel-featured panel-featured-primary">
											<form role="form" action="accounting/fee_category/edit/3" method="post" class="validate">
												<header class="panel-heading">
													<h2 class="panel-title">
														<i class="glyphicon glyphicon-edit"></i> Edit													</h2>
												</header>
												...
												<div class="panel-body">
													<div class="form-group mb-sm">
														...
														<input type="text" class="form-control" required title="Must Be Required" 
														value="Monthly Fees" name="fee_category_name">
													</div>
													...
													<div class="form-group">
														...
														<input type="number" class="form-control" required name="amount" value="1500"/>
													</div>
									...
									<!-- FEES DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/fee_category/delete/3');">
									<i class="el el-trash"></i>
									</a>
								...
								<td>
									<!-- FEES UPDATE  LINK -->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#fee_category4">
									<i class="glyphicon glyphicon-edit"></i> Edit</a>
									<!-- EDIT MODAL FORM -->
									<div id="fee_category4" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<section class="panel panel-featured panel-featured-primary">
											<form role="form" action="accounting/fee_category/edit/4" method="post" class="validate">
												<header class="panel-heading">
													<h2 class="panel-title">
														<i class="glyphicon glyphicon-edit"></i> Edit													</h2>
												</header>
												...
												<div class="panel-body">
													<div class="form-group mb-sm">
														...
														<input type="text" class="form-control" required title="Must Be Required" 
														value="books1" name="fee_category_name">
													</div>
													...
													<div class="form-group">
														...
														<input type="number" class="form-control" required name="amount" value="600"/>
													</div>

													<div class="form-group">
														<label class="control-label">
															Description														</label>
														<textarea class="form-control" name="description" rows="2">cl1</textarea>
													</div>
												</div>
									...
									<!-- FEES DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/fee_category/delete/4');">
									<i class="el el-trash"></i>
									</a>
								...
								<td>
									<!-- FEES UPDATE  LINK -->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#fee_category5">
									<i class="glyphicon glyphicon-edit"></i> Edit</a>
									<!-- EDIT MODAL FORM -->
									<div id="fee_category5" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<section class="panel panel-featured panel-featured-primary">
											<form role="form" action="accounting/fee_category/edit/5" method="post" class="validate">
												<header class="panel-heading">
													<h2 class="panel-title">
														<i class="glyphicon glyphicon-edit"></i> Edit													</h2>
												</header>
												...
												<div class="panel-body">
													<div class="form-group mb-sm">
														...
														<input type="text" class="form-control" required title="Must Be Required" 
														value="transapr" name="fee_category_name">
													</div>
													...
													<div class="form-group">
														...
														<input type="number" class="form-control" required name="amount" value="200"/>
													</div>

													<div class="form-group">
														<label class="control-label">
															Description														</label>
														<textarea class="form-control" name="description" rows="2">bd</textarea>
													</div>
												</div>
									...
									<!-- FEES DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/fee_category/delete/5');">
									<i class="el el-trash"></i>
									</a>
								...
								<td>
									<!-- FEES UPDATE  LINK -->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#fee_category10">
									<i class="glyphicon glyphicon-edit"></i> Edit</a>
									<!-- EDIT MODAL FORM -->
									<div id="fee_category10" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<section class="panel panel-featured panel-featured-primary">
											<form role="form" action="accounting/fee_category/edit/10" method="post" class="validate">
												<header class="panel-heading">
													<h2 class="panel-title">
														<i class="glyphicon glyphicon-edit"></i> Edit													</h2>
												</header>
												...
												<div class="panel-body">
													<div class="form-group mb-sm">
														...
														<input type="text" class="form-control" required title="Must Be Required" 
														value="Admission" name="fee_category_name">
													</div>
													...
													<div class="form-group">
														<label class="control-label">
															Description														</label>
														<textarea class="form-control" name="description" rows="2">Admission Fee</textarea>
													</div>
												</div>
									...
									<!-- FEES DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/fee_category/delete/10');">
									<i class="el el-trash"></i>
									</a>
								...
								<td>
									<!-- FEES UPDATE  LINK -->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#fee_category11">
									<i class="glyphicon glyphicon-edit"></i> Edit</a>
									<!-- EDIT MODAL FORM -->
									<div id="fee_category11" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<section class="panel panel-featured panel-featured-primary">
											<form role="form" action="accounting/fee_category/edit/11" method="post" class="validate">
												<header class="panel-heading">
													<h2 class="panel-title">
														<i class="glyphicon glyphicon-edit"></i> Edit													</h2>
												</header>
												...
												<div class="panel-body">
													<div class="form-group mb-sm">
														...
														<input type="text" class="form-control" required title="Must Be Required" 
														value="sample route, bus001" name="fee_category_name">
													</div>
													...
													<div class="form-group">
														...
														<input type="number" class="form-control" required name="amount" value="6000"/>
													</div>
									...
									<!-- FEES DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/fee_category/delete/11');">
									<i class="el el-trash"></i>
									</a>
								...
								<td>
									<!-- FEES UPDATE  LINK -->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#fee_category12">
									<i class="glyphicon glyphicon-edit"></i> Edit</a>
									<!-- EDIT MODAL FORM -->
									<div id="fee_category12" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<section class="panel panel-featured panel-featured-primary">
											<form role="form" action="accounting/fee_category/edit/12" method="post" class="validate">
												<header class="panel-heading">
													<h2 class="panel-title">
														<i class="glyphicon glyphicon-edit"></i> Edit													</h2>
												</header>
												...
												<div class="panel-body">
													<div class="form-group mb-sm">
														...
														<input type="text" class="form-control" required title="Must Be Required" 
														value="First Term Fees" name="fee_category_name">
													</div>
													...
													<div class="form-group">
														...
														<input type="number" class="form-control" required name="amount" value="8500"/>
													</div>

													<div class="form-group">
														<label class="control-label">
															Description														</label>
														<textarea class="form-control" name="description" rows="2">First Term Fees</textarea>
													</div>
												</div>
									...
									<!-- FEES DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/fee_category/delete/12');">
									<i class="el el-trash"></i>
									</a>
								...
								<td>
									<!-- FEES UPDATE  LINK -->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#fee_category9">
									<i class="glyphicon glyphicon-edit"></i> Edit</a>
									<!-- EDIT MODAL FORM -->
									<div id="fee_category9" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<section class="panel panel-featured panel-featured-primary">
											<form role="form" action="accounting/fee_category/edit/9" method="post" class="validate">
												<header class="panel-heading">
													<h2 class="panel-title">
														<i class="glyphicon glyphicon-edit"></i> Edit													</h2>
												</header>
												...
												<div class="panel-body">
													<div class="form-group mb-sm">
														...
														<input type="text" class="form-control" required title="Must Be Required" 
														value="Admission fee" name="fee_category_name">
													</div>
													...
													<div class="form-group">
														...
														<input type="number" class="form-control" required name="amount" value="20000"/>
													</div>
									...
									<!-- FEES DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/fee_category/delete/9');">
									<i class="el el-trash"></i>
									</a>
