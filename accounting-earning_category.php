...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Earning Category | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-5">
		<section class="panel panel-featured panel-featured-primary">
			<header class="panel-heading">
				<h2 class="panel-title">Add Earning Category</h2>
			</header>
			<div class="panel-body">
				<form role="form" action="accounting/earning_category/make" method="post" class="validate">
					<div class="form-group ">
	...
	<div class="col-md-7">
		<section class="panel panel-featured panel-featured-primary">
			<header class="panel-heading">
				<h2 class="panel-title"><i class="fa fa-list"></i> Earning Category List</h2>
			</header>
					...
					<table class="table table-bordered table-striped table-condensed mb-none">
						...
						<tbody>
								...
								<td>
									...
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#balance_category2"><i class="glyphicon glyphicon-edit"></i>
										Edit</a>
									<div id="balance_category2" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<div class="row">
											<div class="col-md-12">
												<section class="panel panel-featured panel-featured-primary">
													<form role="form" action="accounting/earning_category/edit/2" method="post" class="validate">
														<header class="panel-heading">
														...
														<div class="panel-body">
															<div class="form-group mb-sm">
																<label class="control-label">
																	Earning Category Name <span class="required">*</span>
																</label>
																<input type="text" class="form-control" required title="Must Be Required" value="Bourse" name="balance_category">
															</div>
														</div>
									...
									<!-- EARNING CATEGORY DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/earning_category/delete/2');">
								...
								<td>
									<!-- EARNING CATEGORY UPDATE-->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#balance_category6"><i class="glyphicon glyphicon-edit"></i>
										Edit</a>
									<div id="balance_category6" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<div class="row">
											<div class="col-md-12">
												<section class="panel panel-featured panel-featured-primary">
													<form role="form" action="accounting/earning_category/edit/6" method="post" class="validate">
														<header class="panel-heading">
															<h2 class="panel-title">
																<i class="glyphicon glyphicon-edit"></i> Edit															</h2>
														</header>
														...
														<div class="panel-body">
															<div class="form-group mb-sm">
																...
																<input type="text" class="form-control" required title="Must Be Required" value="bla bla" name="balance_category">
															</div>
														</div>
									...
									<!-- EARNING CATEGORY DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/earning_category/delete/6');">
									<i class="el el-trash"></i>
									</a>
