...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			...
			<div class="panel-body">
			<form action="payroll/salary_control" id="form" method="post" accept-charset="utf-8">
				<div class="row mb-lg">
...
<option value="librarian">Librarian</option>
				...
				<center>
					<button type="submit" name="flag" value="1" class="btn btn-primary">
						<i class="fa fa-check-square-o"></i> Done					</button>
				<center>
			</form>			</div>
		</section>
			...
			<form action="payroll/salary_control/set" class="validate" method="post" accept-charset="utf-8">
			<header class="panel-heading">
				...
				<div class="table-responsive mt-xs mb-md">
					<table class="table table-bordered table-condensed mb-none">
						...
						<tbody>
														<tr>
								<td>1</td>
								<td class="center"><img src="uploads/teacher_image/1.jpg" width="35" height="35" />
								<td>Anzo Perez</td>
								<td>
									<div class="input-group">
										<span class="input-group-addon">
											$										</span>
										<input type="number" class="form-control" required name="salary_1" value="16000">
									</div>
								</td>
							</tr>
														<tr>
								<td>2</td>
								<td class="center"><img src="uploads/teacher_image/2.jpg" width="35" height="35" />
								<td>Johanna Luisa</td>
								<td>
									<div class="input-group">
										<span class="input-group-addon">
											$										</span>
										<input type="number" class="form-control" required name="salary_2" value="16000">
									</div>
								</td>
							</tr>
													</tbody>
		...
		<input name="employee_type" value="teacher" type="hidden">
		</form>	</div>
</div>
