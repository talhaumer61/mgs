...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>SMS Settings | Rudras School</title>
		...
		<div class="panel-group" id="accordion">
			<div class="panel panel-accordion">
				...
				<div id="collapseTwo" class="accordion-body collapse ">
					<div class="panel-body">
						<form action="smssettings/maintain/clickatell" class="form-horizontal validate" target="_top" method="post" accept-charset="utf-8">
							<div class="form-group">
							  <label  class="col-sm-3 control-label">Clickatell Username</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
								<label  class="col-sm-3 control-label">Clickatell Password</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
							  <label  class="col-sm-3 control-label">Clickatell Api Id</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="clickatell_api_id" value="Clickatell 4">
								</div>
							</div>
							<div class="form-group">
							  <div class="col-sm-offset-3 col-sm-5">
								  <input type="checkbox" name="active_switch" value="clickatell" >
							  </div>
							</div>
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-5">
			...
			<div class="panel panel-accordion">
				...
				<div id="collapseThree" class="accordion-body collapse ">
					<div class="panel-body">
						<form action="smssettings/maintain/twilio" class="form-horizontal validate" target="_top" method="post" accept-charset="utf-8">
							<div class="form-group">
							  <label  class="col-sm-3 control-label">Twilio Account SID</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
								<label  class="col-sm-3 control-label">Authentication Token</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
							  <label  class="col-sm-3 control-label">Registered Phone Number</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
							  <div class="col-sm-offset-3 col-sm-5">
								  <input type="checkbox" name="active_switch" value="twilio" >
							  </div>
							</div>
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-5">
			...
			<div class="panel panel-accordion">
				...
				<div id="collapsefour" class="accordion-body collapse ">
					<div class="panel-body">
						<form action="smssettings/maintain/msg91" class="form-horizontal validate" target="_top" method="post" accept-charset="utf-8">
							<div class="form-group">
							  <label  class="col-sm-3 control-label">Sender Id</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="sender_id" 
										value="bulk_sms_Username">
								</div>
							</div>
							<div class="form-group">
								<label  class="col-sm-3 control-label">Authkey</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
							  <div class="col-sm-offset-3 col-sm-5">
								  <input type="checkbox" name="active_switch" value="msg91" >
							  </div>
							</div>
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-5">
			...
			<div class="panel panel-accordion">
				...
				<div id="collapsefive" class="accordion-body collapse ">
					<div class="panel-body">
						<form action="smssettings/maintain/bulk" class="form-horizontal validate" target="_top" method="post" accept-charset="utf-8">
							<div class="form-group">
							  <label  class="col-sm-3 control-label">Username</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="bulk_sms_username" 
										value="shimul_bulk">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" name="bulk_sms_password" 
										value="12345678">
								</div>
							</div>
							<div class="form-group">
							  <div class="col-sm-offset-3 col-sm-5">
								  <input type="checkbox" name="active_switch" value="bulk" >
							  </div>
							</div>
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-5">
...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		$('input[name="active_switch"]').bootstrapSwitch();
    });
</script>				</section>
			</div>
		</section>
