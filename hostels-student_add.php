...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Add New Students | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			...
			<div class="panel-body">
				<form action="hostels/student_add" class="validate" method="post" accept-charset="utf-8">
				<div class="row mb-lg">
					<div class="col-md-3">
						<div class="form-group">
							...
							data-minimum-results-for-search="Infinity" name="class_id" onchange="select_section(this.value)">
					...
					<div class="col-md-3">
						...
						<select class="form-control" required title="Must Be Required" data-plugin-selectTwo data-width="100%"
						data-minimum-results-for-search="Infinity" name="section_id" id="section_holder">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<select class="form-control" required title="Must Be Required" data-plugin-selectTwo data-width="100%"
							data-minimum-results-for-search="Infinity" onchange="get_hostel_room(this.value)" name="hostel_id">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<select class="form-control" required title="Must Be Required" data-plugin-selectTwo data-width="100%"
							data-minimum-results-for-search="Infinity" name="hostel_room_id" id="room_id_holder">
																								<option value="1"> Sample Room </option>
															</select>
						</div>
					</div>
				</div>
				<center>
					<button type="submit" class="btn btn-primary"><i class="fa fa-check-square-o"></i> Control</button>
				</center>
		...
		<form action="hostels/student_add/make" id="form" method="post" accept-charset="utf-8">
			<header class="panel-heading">
				<h2 class="panel-title"><i class="fa fa-user-circle"></i> Student List</h2>
			</header>
			<div class="panel-body">
				<div class="table-responsive mt-sm mb-md">
					<table class="table table-bordered table-striped table-condensed mb-none" id="multi-form">
						...
						<tbody>
									...
									<td>
										<div class="checkbox-custom checkbox-default">
											<input type="checkbox" name="student_id[]" value="8">
											<label for="checkboxExample1"></label>
										</div>
									</td>
									<td class="center"><img src="uploads/student_image/8.jpg" width="30"/></td>
									<td>Joseph Chadwick</td>
									<td>0</td>
									<td>JosephChadwick@gmail.com</td>
								</tr>
													</tbody>
					</table>
				</div>
			...
			<input type="hidden" name="hostel_room_id" value="1"/>
			<div class="panel-footer">
				<center>
					<button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Set Students</button>
				</center>
			</div>
		</form>		</section>
			</div>
...
<script type="text/javascript">
    function select_section(class_id) {
		$.ajax( {
			url: 'hostels/get_class_section/' + class_id,
    ...
    function get_hostel_room(hostel_id) {
		$.ajax( {
			url: 'hostels/get_hostel_room/' + hostel_id,
			success: function ( response ) {
				jQuery( '#room_id_holder' ).html( response );
			}
		} );
    }

	$( "#form" ).submit( function ( event ) {
		$checks = $( "#multi-form tbody input[type='checkbox']" );
		if ($checks.filter(':checked').length == 0) {
			sweetAlert("Oops...", "Please Select Students First !", "error");
			return false;
		} else {
			return true;
		}
