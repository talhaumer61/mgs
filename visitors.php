...
require_once("include/visitorpurpose/visitor/query.php");
...
if(($_SESSION['userlogininfo']['LOGINTYPE'] == '1' && in_array('43', $_SESSION['userlogininfo']['PERMISSIONS'])) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '43', 'view' => '1'))) {
	echo '
	<title>Visitor Panel | '.TITLE_HEADER.'</title>
	<section role="main" class="content-body">
		...
		<div class="row">
			<div class="col-md-12">';
				include_once("include/visitorpurpose/visitor/list.php");
				include_once("include/modals/visitorpurpose/visitor/add.php");
				echo '
			</div>
		</div>
	</section>';
