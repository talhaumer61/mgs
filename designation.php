...
if(($_SESSION['userlogininfo']['LOGINTYPE'] == '1' && in_array('15', $_SESSION['userlogininfo']['PERMISSIONS'])) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '15', 'view' => '1'))) {
	require_once("include/designation/query_designation.php");
	echo'
	...
	<section role="main" class="content-body">
		...
		<div class="row">
			<div class="col-md-12">';
				include_once("include/designation/list_designation.php");
				include_once("include/modals/designation/modal_designation_add.php");
				echo'
			</div>
		</div>
	</section>';
