...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Books Category | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-5">
		<section class="panel panel-featured panel-featured-primary">
			...
			<div class="panel-body">
				<form role="form" action="library/book_category/make" method="post" class="validate">
					<div class="form-group ">
					...
					<table class="table table-bordered table-striped table-condensed mb-none">
						...
						<tbody>
								...
								<td>
									...
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#edit_4"><i class="glyphicon glyphicon-edit"></i> Edit</a>
									
									<!-- MODAL FORM -->
									<div id="edit_4" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<section class="panel panel-featured panel-featured-primary">
											<form role="form" action="library/book_category/update/4" method="post" class="validate">
												<header class="panel-heading">
													<h2 class="panel-title">
														<i class="glyphicon glyphicon-edit"></i> Update Content													</h2>
												</header>
												...
												<div class="panel-body">
													<div class="form-group mb-sm">
														...
														<input type="text" class="form-control" required title="Must Be Required" value="check" name="name">
									...
									<!-- BOOK CATEGORY DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('library/book_category/delete/4');"> 
								...
								<td>
									<!-- BOOK CATEGORY UPDATE -->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#edit_5"><i class="glyphicon glyphicon-edit"></i> Edit</a>
									
									<!-- MODAL FORM -->
									<div id="edit_5" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<section class="panel panel-featured panel-featured-primary">
											<form role="form" action="library/book_category/update/5" method="post" class="validate">
												<header class="panel-heading">
													<h2 class="panel-title">
														<i class="glyphicon glyphicon-edit"></i> Update Content													</h2>
												</header>
												...
												<div class="panel-body">
													<div class="form-group mb-sm">
														...
														<input type="text" class="form-control" required title="Must Be Required" value="Novel" name="name">
									...
									<!-- BOOK CATEGORY DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('library/book_category/delete/5');"> 
										<i class="el el-trash"></i>
									</a>
								...
								<td>
									<!-- BOOK CATEGORY UPDATE -->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#edit_6"><i class="glyphicon glyphicon-edit"></i> Edit</a>
									
									<!-- MODAL FORM -->
									<div id="edit_6" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<section class="panel panel-featured panel-featured-primary">
											<form role="form" action="library/book_category/update/6" method="post" class="validate">
												<header class="panel-heading">
													<h2 class="panel-title">
														<i class="glyphicon glyphicon-edit"></i> Update Content													</h2>
												</header>
												...
												<div class="panel-body">
													<div class="form-group mb-sm">
														...
														<input type="text" class="form-control" required title="Must Be Required" value="Shahzad Ahmad" name="name">
									...
									<!-- BOOK CATEGORY DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('library/book_category/delete/6');"> 
										<i class="el el-trash"></i>
									</a>
