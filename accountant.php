...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Accountant Panel | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			<header class="panel-heading">
				<a class="modal-with-move-anim btn btn-primary btn-xs pull-right" href="#teacher_add"><i class="fa fa-plus-square"></i> Make Accountant</a>
				<h2 class="panel-title"><i class="fa fa-user-circle-o"></i> Accountant List</h2>
			</header>
			<div class="panel-body">
				<table class="table table-bordered table-striped table-condensed mb-none table_default">
					...
					<tbody>
												<tr>
							<td class="center"><img src="uploads/accountant_image/1.jpg" width="35" height="35"/></td>
							<td>Havier Macherano</td>
							<td>04/10/2015</td>
							<td>accountant@rudras.com</td>
							<td>+60-650154545</td>
							<td width="120px">
								<input type="checkbox" id="1" data-size="mini" checked name="user_id" >
							</td>
							<td>
								<!-- ACCOUNTANT UPDATE LINK -->
								<a href="accountant/profile/1" class="btn btn-xs btn-primary" data-placement="top" data-toggle=
								"tooltip" data-original-title="Profile / Edit">
								<i class="el el-user"></i>
								</a>

								<!-- ACCOUNTANT DELETION LINK -->
								<a href="#" class="btn btn-xs btn-danger" onclick="confirm_modal('accountant/maintain/delete/1								');">
		...
		<div id="teacher_add" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
			<section class="panel panel-featured panel-featured-primary">
				<form action="accountant/maintain/make" id="frm" enctype="multipart/form-data" method="post" accept-charset="utf-8">
					...
					<div class="row">
						<div class="col-md-6 mb-xs">
							<div class="form-group">
								...
								<input type="text" class="form-control" required name="birthday" title="Must Be Required" value="" data-plugin-datepicker data-plugin-options='{ "startView": 2 }'>
							</div>
						</div>
		...
		$("form#frm").validate({
			rules: {
				email: {
					email: true,
					remote: {
						url: 'accountant/get_email_exists',
						type: "post",
						data: {
