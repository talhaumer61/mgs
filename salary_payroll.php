...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Payroll Panel | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			...
			<div class="panel-body">
				<form action="payroll/salary" id="form" method="post" accept-charset="utf-8">
					<div class="row mb-lg">
						<div class="col-sm-4">
							<div class="form-group">
								...
								<select name="employee_type" class='form-control populate' required data-plugin-selectTwo data-width='100%'
									data-minimum-results-for-search='Infinity' onchange = 'get_employee_name(this.value)' >
...
<option value="librarian">Librarian</option>
						...
						<div class="col-sm-4">
							...
							<select name="employee_id" class='form-control' id='employee_name_holder' required
								data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity' >
<option value="">Select Type First</option>
<option value="1" selected="selected">Anzo Perez</option>
...
<option value="12">December</option>
		...
		<form action="payroll/payment" class="validate" method="post" accept-charset="utf-8">
					...
					<div class="col-md-6">
						<section class="panel" style="box-shadow: 0 3px 12px 0 rgba(0, 0, 0, 0.15);">
							...
							<div class="panel-body">
								...
								<button type="button" class="btn btn-default mt-md" onclick="add_more_allowances()">
					...
					<div class="col-md-6">
						<section class="panel" style="box-shadow: 0 3px 12px 0 rgba(0, 0, 0, 0.15);">
							...
							<div class="panel-body">
								...
								<button type="button" class="btn btn-default mt-md" onclick="add_more_deduction()">
									<i class="fa fa-plus"></i> Add More								</button>
							</div>
						</section>
					</div>
									...
									<tbody>
										<tr class="b-top-none">
											...
											<td class="text-left">
												<div class="input-group">
													...
													<input type="text" class="form-control" name="basic_salary" readonly value="16000">
												</div>
											</td>
										</tr>
										<tr>
										...
										<tr class="h4">
											...
											<td class="text-left">
												<div class="input-group">
													<span class="input-group-addon">$</span>
													<input type="text" class="form-control" name="net_salary" readonly id="net_salary" value="16000">
												</div>
											</td>
										</tr>
									</tbody>
...
<script type="text/javascript">
	...
	function get_employee_name( type ) {
		$.ajax( {
			url: 'payroll/get_employee_name/' + type,
			success: function ( response ) {
				jQuery( '#employee_name_holder' ).html( response );
			}
		} );
	}
