...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Payment Settings | Rudras School</title>
				...
				<div class="panel-heading">
					<h4 class="panel-title">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
							 Paypal API Settings <span class="label label-primary"> Active </span>						</a>
					</h4>
				</div>
				<div id="collapseOne" class="accordion-body collapse in">
					<div class="panel-body">
						<form action="payment/maintain/paypal" class="form-horizontal validate" method="post" accept-charset="utf-8">
							<div class="form-group">
								<label  class="col-sm-3 control-label">Paypal Username </label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="paypal_username" value="sandbo_1215254764_biz_api1.angelleye.com">
								</div>
							</div>
							<div class="form-group">
								<label  class="col-sm-3 control-label">Paypal Password</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="paypal_password" value="1215254774">
								</div>
							</div>
							<div class="form-group">
								<label  class="col-sm-3 control-label">Paypal Signature</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="paypal_signature" value="AiKZhEEPLJjSIccz.2M.tbyW5YFwAb6E3l6my.pY9br1z2qxKx96W18v">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									value="shimul66@gmail.com">
								</div>
							</div>
							<div class="form-group">
								<label  class="col-sm-3 control-label">Status</label>
								<div class="col-sm-5">
								<select name="paypal_status" class='form-control populate' required data-plugin-selectTwo data-width='100%'
...
<option value="deactive">Deactive</option>
							...
							<div class="form-group">
								<label  class="col-sm-3 control-label">Paypal Sandbox</label>
								<div class="col-sm-5">
				...
				<div class="panel-heading">
					<h4 class="panel-title">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
							Stripe API Settings <span class="label label-primary"> Active </span>						</a>
					</h4>
				</div>
				<div id="collapseTwo" class="accordion-body collapse ">
					<div class="panel-body">
						<form action="payment/maintain/stripe" class="form-horizontal validate" method="post" accept-charset="utf-8">
							<div class="form-group">
							  <label  class="col-sm-3 control-label">Stripe Secret Key</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="stripe_secret_key" 
										value="sk_test_sVZ8Ow8mkH9R2wCOffhK5HAL">
								</div>
							</div>
							<div class="form-group">
								<label  class="col-sm-3 control-label">Status</label>
								<div class="col-sm-5">
								<select name="stripe_status" class='form-control populate' required data-plugin-selectTwo data-width='100%'
									data-minimum-results-for-search='Infinity' >
<option value="active" selected="selected">Active</option>
<option value="deactive">Deactive</option>
</select>
							...
							<div class="form-group">
							  <label  class="col-sm-3 control-label">Stripe Demo</label>
							  <div class="col-sm-5">
								  <input type="checkbox" name="stripe_demo" checked>
							  </div>
							</div>
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-5">
				...
				<div class="panel-heading">
					<h4 class="panel-title">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
							PayUmoney API Settings <span class="label label-primary"> Active </span>						</a>
					</h4>
				</div>
				<div id="collapseThree" class="accordion-body collapse ">
					<div class="panel-body">
						<form action="payment/maintain/payumoney" class="form-horizontal validate" method="post" accept-charset="utf-8">
							<div class="form-group">
							  <label  class="col-sm-3 control-label">Payumoney Key</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="payumoney_key" value="gtKFFx">
								</div>
							</div>
							<div class="form-group">
								<label  class="col-sm-3 control-label">Payumoney Salt</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="payumoney_salt" value="eCwWELxi">
								</div>
							</div>
							<div class="form-group">
								<label  class="col-sm-3 control-label">Status</label>
								<div class="col-sm-5">
								<select name="payumoney_status" class='form-control populate' required data-plugin-selectTwo data-width='100%'
									data-minimum-results-for-search='Infinity' >
<option value="active" selected="selected">Active</option>
<option value="deactive">Deactive</option>
</select>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Payumoney Demo</label>
								<div class="col-sm-5">
								  <input type="checkbox" name="payumoney_demo" checked>
								</div>
							</div>
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-5">
				...
				<div class="panel-heading">
					<h4 class="panel-title">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseFour">
							Mollie API Settings <span class="label label-primary"> Active </span>						</a>
					</h4>
				</div>
				<div id="collapseFour" class="accordion-body collapse ">
					<div class="panel-body">
						<form action="payment/maintain/mollie" class="form-horizontal validate" method="post" accept-charset="utf-8">
							<div class="form-group">
							  <label  class="col-sm-3 control-label">Mollie API Key</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="mollie_api_key" value="test_5N5CdTUSyyHyvpCT4tggjhz8KKGKCc">
								</div>
							</div>
							<div class="form-group">
								<label  class="col-sm-3 control-label">Status</label>
								<div class="col-sm-5">
								<select name="mollie_status" class='form-control populate' required data-plugin-selectTwo data-width='100%'
									data-minimum-results-for-search='Infinity' >
<option value="active" selected="selected">Active</option>
<option value="deactive">Deactive</option>
</select>
