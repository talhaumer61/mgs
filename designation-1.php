...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Teacher Panel | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-5">
		<section class="panel panel-featured panel-featured-primary">
			...
			<div class="panel-body">
				<form role="form" action="teacher/designation/make" method="post" class="validate">
					<div class="form-group ">
						<label class="control-label">Name <span class="required">*</span></label>
						<input type="text" class="form-control" name="designationname" required title="Must Be Required" value="" autofocus />
											</div>
				...
				<div class="table-responsive">
					<table class="table table-bordered table-striped table-condensed mb-none">
						...
						<tbody>
								...
								<td>
									<!-- DESIGNATION UPDATE  LINK -->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#edit1"><i class="glyphicon glyphicon-edit"></i> Edit</a>

									<!-- EDIT MODAL FORM -->
									<div id="edit1" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<div class="row">
											<div class="col-md-12">
												<section class="panel panel-featured panel-featured-primary">
													<form role="form" action="teacher/designation/edit/1" method="post" class="validate">
														<header class="panel-heading">
														...
														<div class="panel-body">
															<div class="form-group mb-sm">
																...
																<input type="text" class="form-control" required title="Must Be Required" value="General teacher" name="designationname">
									...
									<!-- DESIGNATION DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('teacher/designation/delete/1');">
								...
								<td>
									<!-- DESIGNATION UPDATE  LINK -->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#edit2"><i class="glyphicon glyphicon-edit"></i> Edit</a>

									<!-- EDIT MODAL FORM -->
									<div id="edit2" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<div class="row">
											<div class="col-md-12">
												<section class="panel panel-featured panel-featured-primary">
													<form role="form" action="teacher/designation/edit/2" method="post" class="validate">
														<header class="panel-heading">
															<h2 class="panel-title">
																<i class="glyphicon glyphicon-edit"></i> Edit															</h2>
														</header>
														...
														<div class="panel-body">
															<div class="form-group mb-sm">
																...
																<input type="text" class="form-control" required title="Must Be Required" value="Principal" name="designationname">
									...
									<!-- DESIGNATION DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('teacher/designation/delete/2');">
									<i class="el el-trash"></i>
									</a>
								...
								<td>
									<!-- DESIGNATION UPDATE  LINK -->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#edit3"><i class="glyphicon glyphicon-edit"></i> Edit</a>

									<!-- EDIT MODAL FORM -->
									<div id="edit3" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<div class="row">
											<div class="col-md-12">
												<section class="panel panel-featured panel-featured-primary">
													<form role="form" action="teacher/designation/edit/3" method="post" class="validate">
														<header class="panel-heading">
															<h2 class="panel-title">
																<i class="glyphicon glyphicon-edit"></i> Edit															</h2>
														</header>
														...
														<div class="panel-body">
															<div class="form-group mb-sm">
																...
																<input type="text" class="form-control" required title="Must Be Required" value="TESTE" name="designationname">
									...
									<!-- DESIGNATION DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('teacher/designation/delete/3');">
									<i class="el el-trash"></i>
									</a>
