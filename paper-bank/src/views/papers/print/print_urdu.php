                          ...
                          <div dir="rtl">
                            <div class="row mt-sm">
                              <div class="container-fluid">
                                <div class="col-sm-12">
                                <h5 class="pull-right"> <b>1: صحیح جواب کا گھیراؤ کریں۔</b> </h5>
                                ...
                                <div class="table-responsive">
                                  <table class="table table-condensed table-bordered table-striped table-hover text-center mt-sm">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td><?=$sr?></td>
                                          <td><p><?=html_entity_decode($obj['question_urdu'])?></p></td>
                            ...
                            <div class="row mt-sm">
                              <div class="container-fluid">
                                <div class="col-sm-12">
                                  <h5 class="pull-right"><b>2: درج ذیل سوالات کے مختصر جوابات لکھیں۔</b> </h5>
                            ...
                            <div class="row mt-sm">
                              <div class="container-fluid">
                                <div class="col-sm-12">
                                  <b>
                                    <span> &nbsp; &nbsp; (<?=numberToRoman($sr2)?>): <?=html_entity_decode($short['question_urdu'])?></span></b></div><br><br><br>
                                <?php 
                            ...
                            ?>
                              ...
                              <div class="container-fluid">
                                <div class="col-sm-12">
                                  <h5  class="pull-right"><b>3: درج ذیل سوالات کے تفصیل سے جواب دیں۔</b> </h5>
                              ...
                              ?>  
                                <div class="row mt-sm">
                                  <div class="container-fluid">
                                    <div class="col-sm-12"><b> &nbsp;&nbsp; (<?=numberToRoman($sr3)?>): <?=html_entity_decode($long['question_urdu'])?></b></div><br><br><br>
                                    <?php
