            ...
            <div class="col-md-12"> 
                <section class="panel panel-featured-primary">
                    <form action="#" class="mb-lg validate" enctype="multipart/form-data" method="post" accept-charset="utf-8" autocomplete="off">
                                ...
                                <div class="table-responsive">
                                  <table class="table table-condensed table-bordered table-striped table-hover text-center mt-sm">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td><?=$sr?></td>
                                          <td class="text-left"><?=html_entity_decode($obj['question_english'])?></td>
                                          <td><?=$obj['answers_options']['e_option_a']?></td>
                                          <td><?=$obj['answers_options']['e_option_b']?></td>
                                          <td><?=$obj['answers_options']['e_option_c']?></td>
                                          <td><?=$obj['answers_options']['e_option_d']?></td>
                                        </tr>
                                        <?php
                                          $sr++;
                                          endforeach;
                            ...
                            ?>
                            <div class="row mt-sm" id="content">
                              <div class="container-fluid">
                                <div class="col-sm-12 question-title"><b><span>  &nbsp;&nbsp; (<?=numberToRoman($sr2)?>): <?=html_entity_decode($short['question_english'])?></span></b>
                                </div><br><br><br>
                            ...
                            <div class="row mt-sm">
                              ...
                              ?>  
                                <div class="row mt-sm" id="content1">
                                  <div class="container-fluid">
                                    <div class="col-sm-12"><b> &nbsp; &nbsp; (<?=numberToRoman($sr3)?>): <?=html_entity_decode($long['question_english'])?></b></div><br><br><br>
                                    <?php
