          ...
          <div class="row">
            <div class="col-md-6">
              <div class="row" style="margin-bottom: 10px;">
                ...
                <div class="col-md-8">
                  <input type="number" value="<?php if(isset($data['paper_id'])){ echo $data['paper_id'];}else{ echo $data['id']+1;}?>" disabled class="form-control" placeholder="Enter ID" name="id" id="id" required="" title="Must Be Required" aria-required="true">
                </div>
              </div>
        ...
        <table class="table table_default table-bordered table-striped table-condensed mb-none" id="table_export">
          <thead>
            <tr>
              ...
              <th class=" center">Chapters</th>
              <th class=" center" width="140px">Paper Generated</th>
          ...
          <tbody>
            ...
            for ($i = 0; $i < sizeof($data['papers']); $i++) : ?>
              <tr>
                  <td class=" center"><?= $i + 1 ?></td>
                  <td class=" center"><?= $data['papers'][$i]->class->class_name ?></td>
                  <td class=" center"><?= $data['papers'][$i]->subject->subject_name?></td>
                  <td class=" center"><?= $data['papers'][$i]->chapter_from->chapter_no?> - <?= $data['papers'][$i]->chapter_to->chapter_no?></td>
                  <td class=" center"><?= date("d F Y", strtotime($data['papers'][$i]->date_added)) ?></td>
                  <td class=" center ">
                  <a class="btn bg-primary btn-xs ml-xs" data-tippy="Print Paper" target="_blank" href="<?= URLROOT . '/papers/print' . '/' . $data['papers'][$i]->paper_id  ?>"> <i class=" fa fa-print"></i>
                  </a>
                  <a class="btn bg-primary btn-xs ml-xs" data-tippy="Print Key" target="_blank" href="<?= URLROOT . '/papers/print_key' . '/' . $data['papers'][$i]->paper_id  ?>"> <i class=" fa fa-key"></i>
                  </a>
