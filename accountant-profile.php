		...
		<section class="panel">
			<div class="panel-body">
				<div class="thumb-info mb-md">
					<img src="uploads/accountant_image/1.jpg" class="rounded img-responsive">
					<div class="thumb-info-title">
						<span class="thumb-info-inner">
							Havier Macherano						</span>
						...
						<div class="table-responsive">
							<table class="table table-striped table-condensed mb-none">
								<tr>
									...
									<td align="right">Havier Macherano</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td align="right">Hindu</td>
								</tr>
								<tr>
									<td><i class="fa fa-dot-circle-o"></i> Email</td>
									<td align="right">accountant@rudras.com</td>
								</tr>
								<tr>
									<td><i class="fa fa-dot-circle-o"></i> Phone</td>
									<td align="right">+60-650154545</td>
								</tr>
							</table>
						</div>
					</div>
	...
	<div class="col-md-8">
		<div class="tabs tabs-primary">
			<ul class="nav nav-tabs">
				<li class="active">
					<a href="#edit" data-toggle="tab"><i class="fa fa-user"></i> <span class="hidden-xs">Accountant Profile</span></a>
				</li>
				<li class="">
			...
			<div class="tab-content">
				<div id="edit" class="tab-pane active">
				   <form action="accountant/maintain/update/1" class="validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
							...
							<div class="col-md-6">
								<div class="fileinput fileinput-new" data-provides="fileinput">
									<div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
										<img src="uploads/accountant_image/1.jpg" alt="...">
									</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="name" required title="Must Be Required" value="Havier Macherano" 
									autofocus>
								</div>
							</div>
						...
						<div class="row mt-xs">
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea class="form-control" rows="3" name = "address">473 Bonanza Rd, Las Vegas, NV 89101, USA</textarea>
								</div>
							</div>
						</div>
						...
						<div class="row mt-xs">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" data-plugin-datepicker name="birthday" value="08/01/1992" required
							...
							<div class="col-md-6">
								...
								<label class="control-label"> Phone</label>
									<input type="text" class="form-control" name="phone" value="+60-650154545">
								</div>
							</div>
						</div>
						...
						<div class="row mt-sm">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="religion" required title="Must Be Required" value="Hindu">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
...
<option value="AB-">AB-</option>
						...
						<div class="row mt-xs">
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="joining_date" data-plugin-datepicker data-plugin-options='{ "todayHighlight" : true }' required title="
									Must Be Required" value="04/10/2015">
								</div>
							</div>
						</div>
						...
						<div class="row mt-xs mb-md">
							<div class="col-md-12">
								<div class="form-group ">
									...
									<input type="email" class="form-control" name="email" required value="accountant@rudras.com">
																	</div>
							</div>
						</div>
					</fieldset>
					...
					<section class="panel panel-pvs-shadow mt-lg">
						...
						<div class="panel-body">
							<div class="table-responsive">
								...
								<tbody>
									<tr> <td colspan="8"> <h5 class="text-danger text-center">There Are No Records</h5> </td></tr>								</tbody>
								</table>
							</div>
						</div>
					</section>
	            ...
	            <div id="resetpass" class="tab-pane">
					<form action="accountant/maintain/change_password/1" class="form-horizontal validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
						<fieldset class="mt-lg">
							<div class="form-group">
...
<div id="add_bank" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
	<section class="panel panel-featured panel-featured-primary">
		<form action="accountant/bank_info/make/1" class="form-horizontal validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
