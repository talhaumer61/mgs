...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Marks Register Panel | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			<form action="exam/marks" id="form" method="post" accept-charset="utf-8">
			<header class="panel-heading">
			...
			<div class="panel-body">
				<div class="row mb-sm">	
					...
					<div class="col-md-3 mb-sm">
						<div class="form-group">
							...
							<select name="section_id" data-plugin-selectTwo data-width="100%" required title="Must Be Required" id="section_holder" class="form-control populate">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<select name="subject_id" data-plugin-selectTwo data-width="100%" id="subject_holder" required title="Must Be Required" class="form-control populate">
								<option value = "">Select Class First</option>
				...
				<center>
					<button type="submit" class="btn btn-primary"><i class="fa fa-check-square-o"></i> Marks Register</button>
				</center>
			</div>
			</form>		</section>
			...
			<form action="exam/marks_set/1/1/1/1" class="validate" method="post" accept-charset="utf-8">
			<header class="panel-heading">
				<h2 class="panel-title"><i class="fa fa-plus-square" aria-hidden="true"></i> Set Mark Of Class One ( Section A ) - Subject English</h2>
			</header>
			<div class="panel-body">
				<div class="table-responsive mt-xs mb-md">
					<table class="table table-bordered table-condensed mb-none">
						...
						<tbody>
														<tr>
								<td>1</td>
								<td class="center"><img src="uploads/student_image/1.jpg" width="30"/>
									<td>
										Cherri Portnoy									</td>
									<td>101</td>
									<td>100</td>
										...
										<div class="input-group">
											<span class="input-group-addon">
												<div class="checkbox-custom checkbox-danger">
													<input type="checkbox" id="chk78" name="abs_78" >
													<label for="chk78"> <span class="hidden-xs hidden-sm"> Absent</span> </label>
												</div>
											</span>
											<input type="number" class="form-control" required name="mark_78" value="50">
										</div>
									</td>
								</tr>
															<tr>
								<td>2</td>
								<td class="center"><img src="uploads/student_image/2.jpg" width="30"/>
									<td>
										Rudyard Maddox									</td>
									<td>102</td>
									<td>100</td>
									<td>
										<div class="input-group">
											<span class="input-group-addon">
												<div class="checkbox-custom checkbox-danger">
													<input type="checkbox" id="chk79" name="abs_79" >
													<label for="chk79"> <span class="hidden-xs hidden-sm"> Absent</span> </label>
												</div>
											</span>
											<input type="number" class="form-control" required name="mark_79" value="70">
										</div>
									</td>
								</tr>
															<tr>
								<td>3</td>
								<td class="center"><img src="uploads/student_image/3.jpg" width="30"/>
									<td>
										Sweet Mondal									</td>
									<td>103</td>
									<td>100</td>
									<td>
										<div class="input-group">
											<span class="input-group-addon">
												<div class="checkbox-custom checkbox-danger">
													<input type="checkbox" id="chk80" name="abs_80" >
													<label for="chk80"> <span class="hidden-xs hidden-sm"> Absent</span> </label>
												</div>
											</span>
											<input type="number" class="form-control" required name="mark_80" value="90">
										</div>
									</td>
								</tr>
															<tr>
								<td>4</td>
								<td class="center"><img src="uploads/student_image/4.jpg" width="30"/>
									<td>
										Blake Estes									</td>
									<td>104</td>
									<td>100</td>
									<td>
										<div class="input-group">
											<span class="input-group-addon">
												<div class="checkbox-custom checkbox-danger">
													<input type="checkbox" id="chk81" name="abs_81" >
													<label for="chk81"> <span class="hidden-xs hidden-sm"> Absent</span> </label>
												</div>
											</span>
											<input type="number" class="form-control" required name="mark_81" value="70">
										</div>
									</td>
								</tr>
															<tr>
								<td>5</td>
								<td class="center"><img src="uploads/student_image/5.jpg" width="30"/>
									<td>
										Carter Bradford									</td>
									<td>105</td>
									<td>100</td>
									<td>
										<div class="input-group">
											<span class="input-group-addon">
												<div class="checkbox-custom checkbox-danger">
													<input type="checkbox" id="chk82" name="abs_82" >
													<label for="chk82"> <span class="hidden-xs hidden-sm"> Absent</span> </label>
												</div>
											</span>
											<input type="number" class="form-control" required name="mark_82" value="38">
										</div>
									</td>
								</tr>
															<tr>
								<td>6</td>
								<td class="center"><img src="uploads/defualt.png" width="30"/>
									<td>
										Shimul Roy									</td>
									<td>2017</td>
									<td>100</td>
									<td>
										<div class="input-group">
											<span class="input-group-addon">
												<div class="checkbox-custom checkbox-danger">
													<input type="checkbox" id="chk83" name="abs_83" >
													<label for="chk83"> <span class="hidden-xs hidden-sm"> Absent</span> </label>
												</div>
											</span>
											<input type="number" class="form-control" required name="mark_83" value="58">
										</div>
									</td>
								</tr>
															</tbody>
