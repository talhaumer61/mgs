...
<!-- end: sidebar -->
	...
	<div class="col-md-12">
		...
		<section class="panel panel-featured panel-featured-primary">
			...
			<div class="panel-body">
				<form action="transport/student_add" class="validate" method="post" accept-charset="utf-8">
				<div class="row mb-lg">
					<div class="col-md-3">
						<div class="form-group">
							...
							name="class_id" onchange="select_section(this.value)">
					...
					<div class="col-md-3">
						...
						<select class="form-control" required title="Must Be Required" data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity"
						name="section_id" id="section_holder">
		...
		<form action="transport/student_add/make" id="form" method="post" accept-charset="utf-8">
			<header class="panel-heading">
			...
			<input type="hidden" name="transport_route_id" value="1"/>
			<input type="hidden" name="transport_vehicle_id" value="4"/>
...
<script type="text/javascript">
    function select_section(class_id) {
		$.ajax( {
			url: 'transport/get_class_section/' + class_id,
