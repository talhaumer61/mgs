...
<div class="row">
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			<form action="timetable/maintain/update/3" id="form" method="post" accept-charset="utf-8">
			<header class="panel-heading">
				<h2 class="panel-title"><i class="fa fa-clock-o"></i> Make Class Routine</h2>
			</header>
				...
				<div class="row">
					<div class="col-md-6 mt-sm">
						<div class="form-group">
							...
							<select name="section_id" data-plugin-selectTwo data-width="100%" required title="Must Be Required" id="section_holder"
					...
					<div class="col-md-6 mt-sm">
						<div class="form-group">
							...
							<select name="subject_id" data-plugin-selectTwo data-width="100%" id="subject_holder" required title="Must Be Required"
							class="form-control populate">
								<option value="">Select</option>
																<option value="1" >English</option>
																<option value="2" >Bangla</option>
																<option value="3" >Computer</option>
																<option value="4" selected>Mathematics</option>
															</select>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-6 mt-sm">
						<div class="form-group">
							<label class="control-label">
								Class Room							</label>
							<input type="text" value = "#2" class="form-control" name="class_room" value="">
						</div>
					</div>
				</div>
				...
				<div class="row mb-sm">
					<div class="col-md-4 mt-sm">
						<div class="form-group">
							...
							<select name="teacher_id" data-plugin-selectTwo data-minimum-results-for-search="Infinity" data-width="100%" required
					...
					<div class="col-md-4 mt-sm">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" name="time_start" value = "11:25 PM" required title="Must Be Required"
					...
					<div class="col-md-4 mt-sm">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" name="time_end" value = "9:25 PM" required title="Must Be Required"
								data-plugin-timepicker class="form-control" data-plugin-options='{ "minuteStep": 5 }'>
							</div>
						</div>
					</div>
