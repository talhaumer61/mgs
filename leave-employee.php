	...
	<div class="col-md-12">
		<section class="panel panel-featured panel-featured-primary">
			<header class="panel-heading">
				<a href="#set_leave" class="btn btn-primary btn-xs modal-with-move-anim pull-right">
				   <i class="fa fa-plus-square"></i> Apply Leave				</a>
				<h2 class="panel-title"><i class="fa fa-list"></i> Leave List</h2>
			</header>
			<div class="panel-body">
				<table class="table table-bordered table-striped mb-none table_default">
					...
					<tbody>
							...
							<td>23-Jan-2019</td>
							<td>
								<span class="label label-success" style="font-size: 10px;">Accepted</span>							</td>
						</tr>
												<tr>
							<td>2</td>
							<td>Anzo Perez</td>
		...
		<!-- SET NEW LEAVE MODAL BOX -->
		<div id="set_leave" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
			<section class="panel panel-featured panel-featured-primary">
			<form action="leave/control/request" class="validate" method="post" accept-charset="utf-8">
				<header class="panel-heading">
					<h2 class="panel-title"><i class="fa fa-plus-square"></i> Apply Leave</h2>
				</header>
				<div class="panel-body">
					<div class="col-md-12 mb-lg mt-md">
						<section class="panel mb-lg" style="box-shadow: 0 3px 12px 0 rgba(0, 0, 0, 0.15);">
							<header class="panel-heading" style="border-bottom: 2px solid #0088cc;">
								<h2 class="panel-title">My Leave Statistics</h2>
							</header>
							<div class="panel-body">
																	<label class="control-label">Sample 1 (0/10)</label>    
									<div class="progress progress-lg progress-squared light" style="margin-top: 2px; margin-bottom: 8px;">
									...
									<div class="progress progress-lg progress-squared light" style="margin-top: 2px; margin-bottom: 8px;">
										<div class="progress-bar" role="progressbar" aria-valuenow="9" aria-valuemin="0" aria-valuemax="15" 
										style="width: 60.0%;">
											60.0 %
										</div>
									</div>
																		<label class="control-label">Sample 3 (1/20)</label>    
									<div class="progress progress-lg progress-squared light" style="margin-top: 2px; margin-bottom: 8px;">
										<div class="progress-bar" role="progressbar" aria-valuenow="1" aria-valuemin="0" aria-valuemax="20" 
										style="width: 5.0%;">
											5.0 %
										</div>
									</div>
						...
						<div class="form-group">
							...
							<select name="leave_category" class='form-control' required data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity' >
<option value="" selected="selected">Select</option>
<option value="11">Sample 1</option>
<option value="12">Sample 2</option>
<option value="13">Sample 3</option>
</select>
						</div>
						...
						<div class="form-group">
							...
							<div class="input-daterange input-group" data-plugin-datepicker data-plugin-options='{ "todayHighlight" : true }' >
								...
								<input type="text" class="form-control" name="start_date" required title="Must Be Required">
