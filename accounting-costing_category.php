...
<html class=" sidebar-light sidebar-left-big-icons">
	...
	<head>
		<!-- BASIC -->
		<meta charset="UTF-8">
		<title>Costing Category | Rudras School</title>
...
<!-- end: sidebar -->
	...
	<div class="col-md-5">
		<section class="panel panel-featured panel-featured-primary">
			<header class="panel-heading">
				<h2 class="panel-title">Add Costing Category</h2>
			</header>
			<div class="panel-body">
				<form role="form" action="accounting/costing_category/make" method="post" class="validate">
					<div class="form-group ">
						<label class="control-label">
							Name <span class="required">*</span>
						</label>
						<input type="text" class="form-control" name="balance_category" required title="Must Be Required" value="" autofocus />
											</div>

					<div class="form-group">
						<button class="btn btn-primary pull-right" type="submit"><i class="fa fa-plus-square"></i> Save</button>
					</div>
				</form>
			</div>
		</section>
	...
	<div class="col-md-7">
		<section class="panel panel-featured panel-featured-primary">
			<header class="panel-heading">
				<h2 class="panel-title"><i class="fa fa-list"></i> Costing Category List</h2>
			</header>
				...
				<div class="table-responsive">
					<table class="table table-bordered table-striped table-condensed mb-none">
						...
						<tbody>
								...
								<td>
									<!-- COSTING CATEGORY UPDATE -->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#balance_category1"><i class="glyphicon glyphicon-edit"></i>
										Edit</a>
									<div id="balance_category1" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<div class="row">
											<div class="col-md-12">
												<section class="panel panel-featured panel-featured-primary">
													<form role="form" action="accounting/costing_category/edit/1" method="post" class="validate">
														<header class="panel-heading">
														...
														<div class="panel-body">
															<div class="form-group mb-sm">
																<label class="control-label">
																	Costing Category Name <span class="required">*</span>
																</label>
																<input type="text" class="form-control" required title="Must Be Required" value="Building development" name="balance_category">
															</div>
														</div>
									...
									<!-- COSTING CATEGORY DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/costing_category/delete/1');">
								...
								<td>
									<!-- COSTING CATEGORY UPDATE -->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#balance_category3"><i class="glyphicon glyphicon-edit"></i>
										Edit</a>
									<div id="balance_category3" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<div class="row">
											<div class="col-md-12">
												<section class="panel panel-featured panel-featured-primary">
													<form role="form" action="accounting/costing_category/edit/3" method="post" class="validate">
														<header class="panel-heading">
															<h2 class="panel-title">
																<i class="glyphicon glyphicon-edit"></i> Edit															</h2>
														</header>
														...
														<div class="panel-body">
															<div class="form-group mb-sm">
																...
																<input type="text" class="form-control" required title="Must Be Required" value="office expense" name="balance_category">
															</div>
														</div>
									...
									<!-- COSTING CATEGORY DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/costing_category/delete/3');">
									<i class="el el-trash"></i>
									</a>
								...
								<td>
									<!-- COSTING CATEGORY UPDATE -->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#balance_category4"><i class="glyphicon glyphicon-edit"></i>
										Edit</a>
									<div id="balance_category4" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<div class="row">
											<div class="col-md-12">
												<section class="panel panel-featured panel-featured-primary">
													<form role="form" action="accounting/costing_category/edit/4" method="post" class="validate">
														<header class="panel-heading">
															<h2 class="panel-title">
																<i class="glyphicon glyphicon-edit"></i> Edit															</h2>
														</header>
														...
														<div class="panel-body">
															<div class="form-group mb-sm">
																...
																<input type="text" class="form-control" required title="Must Be Required" value="Genarell fund" name="balance_category">
															</div>
														</div>
									...
									<!-- COSTING CATEGORY DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/costing_category/delete/4');">
									<i class="el el-trash"></i>
									</a>
								...
								<td>
									<!-- COSTING CATEGORY UPDATE -->
									<a class="modal-with-move-anim-pvs btn btn-primary btn-xs" href="#balance_category5"><i class="glyphicon glyphicon-edit"></i>
										Edit</a>
									<div id="balance_category5" class="mfp-with-anim modal-block modal-block-primary mfp-hide">
										<div class="row">
											<div class="col-md-12">
												<section class="panel panel-featured panel-featured-primary">
													<form role="form" action="accounting/costing_category/edit/5" method="post" class="validate">
														<header class="panel-heading">
															<h2 class="panel-title">
																<i class="glyphicon glyphicon-edit"></i> Edit															</h2>
														</header>
														...
														<div class="panel-body">
															<div class="form-group mb-sm">
																...
																<input type="text" class="form-control" required title="Must Be Required" value="ROD" name="balance_category">
															</div>
														</div>
									...
									<!-- COSTING CATEGORY DELETE LINK -->
									<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal('accounting/costing_category/delete/5');">
									<i class="el el-trash"></i>
									</a>
